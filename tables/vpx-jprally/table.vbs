...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Rally - Taito 1980" & vbNewLine & "VPX table by JPSalas v.5.5.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub LeftSlingShot_Timer
    Select Case LStep
        ...
        Case 3:LeftSLing2.Visible = 0:Lemk.RotX = -14:LeftSlingShot.TimerEnabled = 0
    End Select
    LStep = LStep + 1
End Sub
...
Sub RightSlingShot_Timer
    Select Case RStep
        ...
        Case 3:RightSLing2.Visible = 0:Remk.RotX = -14:RightSlingShot.TimerEnabled = 0
    End Select
    RStep = RStep + 1
End Sub
