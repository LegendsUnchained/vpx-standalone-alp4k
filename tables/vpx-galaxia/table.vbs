' Galaxia by LTD do Brasil from 1975
' vpx table by jpsalas & Halen v 1.0.0
...
' Valores Constants
Const TableName = "LTDGalaxia" ' file name to save highscores and other variables
Const cGameName = "LTDGalaxia" ' B2S name
...
Sub Table1_KeyDown(ByVal Keycode)
    ...
    If keycode = LeftMagnaSave Then bLutActive = True:Lutbox.text = "Color LUT image: " & table1.ColorGradeImage
...
'************************************************
' Real Time Flipper adjustments - by JLouLouLou
...
Sub EndOfBall()
    ...
    If NOT Tilted Then
        BonusCountTimer.Interval = 250 + 150 * BonusMultiplier
...
Sub AddTargetMulti(n)
    TargetMulti = (TargetMulti + n)MOD 6
...
Sub RubberBand016_Hit:AddScore 10:End Sub
Sub RubberBand010_Hit:AddScore 10:End Sub
Sub RubberBand011_Hit:AddScore 10:End Sub
...
Sub CheckTargets
    Dim tmp
    tmp = light012.State + light017.state + light018.State
    If tmp = 3 Then
        Light001.State = 1
        BonusMultiplier = 2
    End If
