' Twister Sega Table build by 32assassin and francisco666 with code rebuild by 32assassin and arngrim scripted DOF and test
...
End Sub
	...
	Dim plungerIM
    Const IMPowerSetting = 25 'Plunger Power
...
Sub sw17_Hit:Controller.Switch(17) = 1 : PlaySoundAtBall "rollover" : End Sub 
Sub sw17_UnHit:Controller.Switch(17) = 0:End Sub
Sub sw18_Hit:Controller.Switch(18) = 1 : PlaySoundAtBall "rollover" : End Sub 
Sub sw18_UnHit:Controller.Switch(18) = 0:End Sub
Sub sw19_Hit:Controller.Switch(19) = 1 : PlaySoundAtBall "rollover" : End Sub 
Sub sw19_UnHit:Controller.Switch(19) = 0:End Sub
Sub sw21_Hit:Controller.Switch(21) = 1 : PlaySoundAtBall "rollover" : End Sub 
Sub sw21_UnHit:Controller.Switch(21) = 0:End Sub
Sub sw23_Hit:Controller.Switch(23) = 1 : PlaySoundAtBall "rollover": End Sub 
Sub sw23_UnHit:Controller.Switch(23) = 0:End Sub
Sub sw25_Hit:Controller.Switch(25) = 1 : End Sub 
Sub sw25_UnHit:Controller.Switch(25) = 0:End Sub
Sub sw57_Hit:Controller.Switch(57) = 1 : PlaySoundAtBall "rollover": End Sub 
Sub sw57_UnHit:Controller.Switch(57) = 0:End Sub
Sub sw58_Hit:Controller.Switch(58) = 1 : PlaySoundAtBall "rollover" : End Sub 
Sub sw58_UnHit:Controller.Switch(58) = 0:End Sub
Sub sw61_Hit:Controller.Switch(61) = 1 : PlaySoundAtBall "rollover" : End Sub 
...
sub Trigger1_hit:magnetdisco.GrabCenter = True:End Sub
...
Sub Targets_Hit (idx)
	PlaySound "target", 0, Vol(ActiveBall)*4, AudioPan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
End Sub
...
Sub Rubbers_Hit(idx)
 	...
 	If finalspeed > 20 then 
		PlaySound "fx_rubber2", 0, Vol(ActiveBall)/3, AudioPan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
	End if
...
Sub RandomSoundRubber()
	Select Case Int(Rnd*3)+1
		Case 1 : PlaySound "rubber_hit_1", 0, Vol(ActiveBall)/3, AudioPan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
		Case 2 : PlaySound "rubber_hit_2", 0, Vol(ActiveBall)/3, AudioPan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
		Case 3 : PlaySound "rubber_hit_3", 0, Vol(ActiveBall)/3, AudioPan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
	End Select
End Sub
...
sub changetonormal
	dim luz
	For each luz in GI:luz.color = RGB(255,207,164):	Next
end sub 
