...
Sub Table1_KeyUp(ByVal Keycode)
	...
	If KeyCode = PlungerKey Then
		...
		End If
	End If
	If keycode = StartGameKey Then PuPEvent 802
...
Sub Bumper2_Hit:vpmTimer.PulseSw 39:RandomSoundBumperMiddle Bumper2:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 38:RandomSoundBumperBottom Bumper3:End Sub

' Drain holes
Sub Drain_Hit : PuPevent 810
	BIP = BIP - 1
	bsTrough.AddBall Me
...
' Saucer
Sub sw24_Hit:SoundSaucerLock:bsTP.AddBall Me:End Sub
...
Dim ST5, ST19, ST28, ST29, ST30, ST31, ST32
...
Set ST5 = (new StandupTarget)(sw5, sw5p, 5, 0)
...
Dim STArray
STArray = Array(ST5, ST19, ST28, ST29, ST30, ST31, ST32)
...
select case countr
case 1 : box001.z=110:box002.z=-200:box003.z=-200:box004.z=-200
case 2 : box001.z=-200:box002.z=110:box003.z=-200:box004.z=-200
case 3 : box001.z=-200:box002.z=-200:box003.z=110:box004.z=-200
case 4 : box001.z=-200:box002.z=-200:box003.z=-200:box004.z=110
