...
Sub Table1_Init
	...
	On Error Resume Next
		...
		.ShowTitle=0
		.hidden = 1
        .Games("wolfman").Settings.Value("sound") = 0
		'.PuPHide = 1
         On Error Resume Next
         .Run GetPlayerHWnd
...
If musicNum = 0 Then PlayMusic "HallOates/Out of Touch.mp3" End If
If musicNum = 1 Then PlayMusic "HallOates/You Make My Dreams.mp3" End If
If musicNum = 2 Then PlayMusic "HallOates/I Can't Go for That.mp3" End If
If musicNum = 3 Then PlayMusic "HallOates/Kiss On My List.mp3" End If
If musicNum = 4 Then PlayMusic "HallOates/Rich Girl.mp3" End If
If musicNum = 5 Then PlayMusic "HallOates/Sara Smile.mp3" End If
If musicNum = 6 Then PlayMusic "HallOates/Maneater.mp3" End If
If musicNum = 7 Then PlayMusic "HallOates/Private Eyes.mp3" End If
If musicNum = 8 Then PlayMusic "HallOates/Adult Education.mp3" End If
If musicNum = 9 Then PlayMusic "HallOates/Method of Modern Love.mp3" End If
If musicNum = 10 Then PlayMusic "HallOates/Did It In a Minute.mp3" End If
If musicNum = 11 Then PlayMusic "HallOates/It's a Laugh.mp3" End If
If musicNum = 12 Then PlayMusic "HallOates/One On One.mp3" End If
If musicNum = 13 Then PlayMusic "HallOates/Family Man.mp3" End If
If musicNum = 14 Then PlayMusic "HallOates/Say It Isn't So.mp3" End If
If musicNum = 15 Then PlayMusic "HallOates/Some Things Are Better Left Unsaid.mp3" End If
If musicNum = 16 Then PlayMusic "HallOates/Wait for Me.mp3" End If
If musicNum = 17 Then PlayMusic "HallOates/You've Lost That Lovin' Feeling.mp3" End If

musicNum = (musicNum + 1) mod 18
...
Sub Bumper1_Hit : vpmTimer.PulseSw(1) : RandomSoundBumperTop Bumper1 : FlashForMs BLight001, 1000, 50, 0:End Sub
Sub Bumper2_Hit : vpmTimer.PulseSw(2) : RandomSoundBumperMiddle Bumper2: FlashForMs BLight002, 1000, 50, 0:End Sub
Sub Bumper3_Hit : vpmTimer.PulseSw(4) : RandomSoundBumperBottom Bumper3: FlashForMs BLight003, 1000, 50, 0:  End Sub
...
'Rotate the idols
CatR.Rotz = 90 - (BOT(2).Y)\15
CatL.Rotz = -90 + (BOT(2).Y)\15
...
Sub SoundHeavyGate()
        PlaySoundAtLevelStatic ("Gate1"), GateSoundLevel, Activeball
End Sub
...
Sub SoundSaucerLock()
        PlaySoundAtLevelStatic ("Saucer_Enter" & Int(Rnd*2)+1), SaucerLockSoundLevel, Activeball
End Sub
...
Sub Table1_exit()
  If B2SOn Then
    ...
    Controller.Stop
    Controller.Games("wolfman").Settings.Value("sound") = 1
  End If
End Sub
'***************
