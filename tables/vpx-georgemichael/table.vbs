...
Sub table1_KeyDown(ByVal Keycode)
	...
	If keycode = StartGameKey Then PlayMusic "faith\intro.ogg"
...
If musicNum = 0 Then PlayMusic "faith\faith.ogg" End If
If musicNum = 1 Then PlayMusic "faith\father figure.ogg" End If
If musicNum = 2 Then PlayMusic "faith\I want your sex.ogg" End If
If musicNum = 3 Then PlayMusic "faith\one more try.ogg" End If
If musicNum = 4 Then PlayMusic "faith\hard day.ogg" End If
If musicNum = 5 Then PlayMusic "faith\hand to mouth.ogg" End If
If musicNum = 6 Then PlayMusic "faith\look at your hands.ogg" End If
If musicNum = 7 Then PlayMusic "faith\monkey.ogg" End If
If musicNum = 8 Then PlayMusic "faith\kissing a fool.ogg" End If
If musicNum = 9 Then PlayMusic "faith\a last request.ogg" End If
...
' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 50:PlaySound SoundFXDOF("fx_bumper", 206, DOFPulse, DOFContactors), 0, 1, 0:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 50:PlaySound SoundFXDOF("fx_bumper", 205, DOFPulse, DOFContactors), 0, 1, 0:End Sub

' Drain & Saucers
Sub Drain_Hit:Playsound "fx_drain":bsTrough.AddBall Me:End Sub

' Rollovers
Sub sw14_Hit:Controller.Switch(14) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):DOF 203, DOFOn:End Sub
Sub sw14_UnHit:Controller.Switch(14) = 0:DOF 203, DOFOff:End Sub

Sub sw14a_Hit:Controller.Switch(14) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):DOF 204, DOFOn:End Sub
...
Sub sw40_Hit:Controller.Switch(40) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):DOF 201, DOFOn:End Sub
Sub sw40_UnHit:Controller.Switch(40) = 0:DOF 201, DOFOff:End Sub

Sub sw40a_Hit:Controller.Switch(40) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):DOF 202, DOFOn:End Sub
...
'Targets
Sub sw44_Hit:vpmTimer.PulseSw 44:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
...
Sub sw11_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
