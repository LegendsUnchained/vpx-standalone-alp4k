' Carnaval no Rio by LTD do Brasil from 1975, version 1981
...
' Valores Constants
Const TableName = "carnavalnorio" ' file name to save highscores and other variables
Const cGameName = "carnavalnorio" ' B2S name
...
Sub Realtime_Timer
    RollingUpdate
'flip001.RotX = flipper001.CurrentAngle
End Sub
...
Sub Verification_Match()
    PlaySound "fx_match"
    Match = INT(RND(1) * 10) * 10 ' random between 0, 10 20, 30... 90
    Display_Match
...
Sub Clear_Match() 'not used in this table
    Match = 0
...
Sub ResetNewBallVariables() 'init variables & lights new ball/player
    TurnOffPlayfieldLights
    BonusMultiplier = 1
    If Balls = 5 Then BonusMultiplier = 2:Light005.State = 1
    Bonus = 0:DigitsUpdate
Light001.State = 1
Light002.State = 1
Light003.State = 1
...
Sub Bumper002_Hit 'right bumper
    If Tilted Then Exit Sub
...
Sub Trigger007_Hit
    ...
    If Tilted Then Exit Sub
    AddScore 1000
    If SpecialisLit Then AwardSpecial
End Sub
...
Sub Trigger008_Hit
    PlaySoundAt "fx_sensor", Trigger003
    If Tilted Then Exit Sub
    If Light009.State Then AddBonus 1
End Sub

Sub Trigger009_Hit
    PlaySoundAt "fx_sensor", Trigger009
    If Tilted Then Exit Sub
    If Light008.State Then AddBonus 1
End Sub
...
Sub rsband008_Hit:AddScore 10:End Sub
Sub rlband006_Hit:AddScore 10:End Sub
Sub rlband004_Hit:AddScore 10:End Sub

'spinner

Sub spinner001_Spin:PlaySoundAt"fx_spinner", spinner001: Addscore 100:End Sub
Sub spinner001_Animate:Primitive046.Rotx = spinner001.CurrentAngle:End Sub

Sub spinner002_Spin:PlaySoundAt"fx_spinner", spinner002: Addscore 100:End Sub
Sub spinner002_Animate:Primitive045.Rotx = spinner002.CurrentAngle:End Sub
...
Sub CheckSpecial
    If Light004.State + Light006.State + Light007.State = 3 Then
        SpecialisLit = True
    End If
End Sub