...
|-----------|----------|-----------|-----|--------------|-----|
| :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | 58-60 |
...
- POV is based on the Loaded Weapon (LW) POV for this table.
- `table.vbs` has an `ALP 4KP PERFORMANCE OPTIONS` block at the bottom. It hides overlapping insert halo lights, thins the laser tower lights, removes the full-table flasher bloom, and switches GI instantly, which stops frame drops on pop bumper hits. Set any option to `0` to restore the original look.
