...
Sub Kicker2_Timer()
	...
	Playsound SoundFXDOF("Middle_KickerHoleKick",121,DOFPulse,DOFContactors)
	DOF 124, DOFPulse
	Kicker2.kick 120,13
	Pkickarm2.rotz=0
...
Sub Kicker3_Timer()
	...
	Playsound SoundFXDOF("Right_KickerHoleKick",122,DOFPulse,DOFContactors)
	DOF 124, DOFPulse
	Kicker3.kick 210,10
	Pkickarm3.rotz=0
...
'	Kicker4.timerenabled=0
	...
	Playsound SoundFXDOF("Left_EMKicker",123,DOFPulse,DOFContactors)
	DOF 124, DOFPulse
	Kicker4.kick 0,(int(rnd(1)*7)+20)
end sub
...
Sub Targets_Hit (idx)
	PlaySound "metalhit2", 0, OV, AudioPan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
End Sub

Sub Metals_Thin_Hit (idx)
	PlaySound "GridL", 0, OV, AudioPan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
End Sub
...
Sub RandomSoundFlipper()
	Select Case Int(Rnd*3)+1
		Case 1 : PlaySound "flip_hit_1", 0, OV*5, AudioPan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
		Case 2 : PlaySound "flip_hit_2", 0, OV*5, AudioPan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
		Case 3 : PlaySound "flip_hit_3", 0, OV*5, AudioPan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
	End Select
End Sub
