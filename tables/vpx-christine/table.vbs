...
Sub FlipperTimer_Timer
	...
	if llane10.state=0 then plastic1.image="Christine Plastics_scan1"
	if llane10.state=1 then plastic1.image="Christine Plastics_scan1"
	if llane10.state=0 then plastic2.image="Christine Plastics_scan2"
	if llane10.state=1 then plastic2.image="Christine Plastics_scan2"
	if llane10.state=0 then plastic3.image="Christine Plastics_scan1"
	if llane10.state=1 then plastic3.image="Christine Plastics_scan1"
	if llane10.state=0 then plastic4.image="Christine Plastics_scan2"
	if llane10.state=1 then plastic4.image="Christine Plastics_scan2"
...
Sub Dragon_Init
	...
	On Error Resume Next
		...
		.SplashInfoLine="John Carpenters Christine (TBA 2019)"
		.HandleMechanics=0
		.HandleKeyboard=0
		.ShowDMDOnly=1
		.ShowFrame=0
...
'Sub Drain_Hit()
	'PlaySound "fx_drain",0,1,0,0.25 : bstrough.addball me
'End Sub
...
Sub RightSlingShot_Slingshot
	vpmTimer.PulseSw 44
    PlaySoundat SoundFXDOF("right_slingshot",101,DOFPulse,DOFContactors), slingL
    RSling.Visible = 0
    RSling1.Visible = 1
	slingR.objroty = 15
    RStep = 1
    ReftSlingShot.TimerEnabled = 1
End Sub
