...
Sub ACDC_KeyDown(ByVal Keycode)
	...
	If KeyCode = PlungerKey OR KeyCode = LockbarKey Then Controller.Switch(64)=1				'FIRE Button, mapped to the right magna save
...
Sub ACDC_KeyUp(ByVal Keycode)
	...
	If KeyCode = PlungerKey OR KeyCode = LockbarKey Then Controller.Switch(64)=0				'FIRE Button, mapped to the right magna save
