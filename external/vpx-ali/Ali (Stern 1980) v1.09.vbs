...
' v4.0 - JPSalas - 2022
' Original VPX table by JPSalas 2017, updated in 2022 - v4.0
' Dipswitches from the older table by Luvthatapex, Joe Entropy and Moonchild
' DOF by Angrim
' Improved Playfield and Plastics by Hauntfreaks
 
' v1.09 - TastyWasps - 2024
' Physics, Sounds, Playfield Mesh, Play Balance, Lighting Tweaks, VR updates by TastyWasps
' Playfield / Plastic upscales by Redbone
' VR Assets / Textures from Rajo Joey and Hauntfreaks
...
Const TargetBouncerFactor = 0.5	  ' Level of bounces. Recommmended value of 0.7
...
If RenderingMode = 2 or LiveViewVRSim = 1 Then
	...
	For Each VR_Obj in VRBoxingRing : VR_Obj.Visible = 1 : Next
	For Each VR_Obj in VRBackglass : VR_Obj.Visible = 1 : Next
	SetBackglass
	' These modifications below are to deal with the fact the VPX 10.8 does not render native kicker objects correctly in VR.
	Kicker001.DrawStyle = 0
	Kicker002.DrawStyle = 0
	Kicker003.DrawStyle = 0
	Kicker004.DrawStyle = 0
	pSaucerFloorLeft.Visible = 1
	pSaucerFloorMiddle.Visible = 1
	pSaucerFloorRight.Visible = 1
	pSaucerFloorTube.Visible = 1
	pKickerLeft.Visible = 1
	pKickerMiddle.Visible = 1
	pKickerRight.Visible = 1
	pKickerTube.Visible = 1
Else
	VRMode = False
	For Each VR_Obj in VRCabinet : VR_Obj.Visible = 0 : Next
	For Each VR_Obj in VRBoxingRing : VR_Obj.Visible = 0 : Next
	For Each VR_Obj in VRBackglass : VR_Obj.Visible = 0 : Next
	For Each VR_Obj in VRBackglassFlashers : VR_Obj.Visible = 0 : Next
End If
...
Sub SetBackglass
	Dim obj
	For Each obj In VRBackglassFlashers
		obj.x = obj.x + 15
		obj.height = - obj.y + -50
		obj.y = 175 'adjusts the distance from the backglass towards the user
		obj.RotX = 270
	Next
End Sub
...
Sub Table1_Init
    With Controller
        .GameName = cGameName
        .SplashInfoLine = "Ali - Stern 1980" & vbNewLine & "VPX table by JPSalas & TastyWasps"
    ...
    With bsTrough
        ...
        .InitExitSnd "BallRelease1", "fx_Solenoid"
        .Balls = 1
    End With
...
Sub LoadLUT
    ...
    If(x <> "")Then LUTImage = x Else LUTImage = 2
    UpdateLUT
End Sub
...
' Bumpers
Sub LBumper_Hit:vpmTimer.PulseSw 13:RandomSoundBumperTop LBumper:End Sub
Sub RBumper_Hit:vpmTimer.PulseSw 12:RandomSoundBumperMiddle RBumper:End Sub
Sub BBumper_Hit:vpmTimer.PulseSw 14:RandomSoundBumperBottom BBumper:End Sub
 
' Drain & holes
Sub Drain_Hit:RandomSoundDrain Drain:bsTrough.AddBall Me:End Sub
Sub sw30_Hit:bsHole1.AddBall 0:SoundSaucerLock:End Sub
Sub sw31_Hit:bsHole2.AddBall 0:SoundSaucerLock:End Sub
Sub sw32_Hit:bsHole3.AddBall 0:SoundSaucerLock:End Sub
Sub sw38_Hit:bsRHole.AddBall 0:SoundSaucerLock:End Sub
 
' Rollovers
Sub sw35_Hit:Controller.Switch(35) = 1:End Sub
Sub sw35_UnHit:Controller.Switch(35) = 0:End Sub
 
Sub sw37_Hit:Controller.Switch(37) = 1:CheckGREATEST:End Sub
Sub sw37_UnHit:Controller.Switch(37) = 0:End Sub
 
Sub sw36_Hit:Controller.Switch(36) = 1:CheckGREATEST:End Sub
...
Sub sw5_Hit:Controller.Switch(5) = 1:CheckGREATEST:End Sub
...
' Targets
Sub sw25_Hit:STHit 25:CheckGREATEST:End Sub
Sub sw26_Hit:STHit 26:CheckGREATEST:End Sub
Sub sw27_Hit:STHit 27:CheckGREATEST:End Sub
Sub sw28_Hit:STHit 28:CheckGREATEST:End Sub
Sub sw29_Hit:STHit 29:CheckGREATEST:End Sub

Sub LeftDropSweep1_Hit
	dtLBank.Hit 1
	dtLBank.Hit 2
	LeftDropSweep1.Collidable = 0
End Sub

Sub LeftDropSweep2_Hit
	dtLBank.Hit 2
	dtLBank.Hit 3
	LeftDropSweep2.Collidable = 0
End Sub

Sub TopDropSweep1_Hit
	dtTBank.Hit 1
	dtTBank.Hit 2
	TopDropSweep1.Collidable = 0
End Sub

Sub TopDropSweep2_Hit
	dtTBank.Hit 2
	dtTBank.Hit 3
	TopDropSweep2.Collidable = 0
End Sub

Sub DTSweepTimer_Timer

	If sw22.IsDropped = 0 and sw23.IsDropped = 0 and sw24.IsDropped = 0 Then
		LeftDropSweep1.Collidable = 1
		LeftDropSweep2.Collidable = 1
	End If

	If sw19.IsDropped = 0 and sw20.IsDropped = 0 and sw21.IsDropped = 0 Then
		TopDropSweep1.Collidable = 1
		TopDropSweep2.Collidable = 1
	End If
...
' Spinner
Sub Spinner1_Spin:vpmTimer.PulseSw 9:PlaySoundAt "Spinner", Spinner1:End Sub
...
Sub SetupVRBackglass
	...
	xoff = 12
	yoff1 = 170 ' this is where you adjust the forward/backward position for player 1 score
	yoff2 = 170 ' this is where you adjust the forward/backward position for player 2 score
	yoff3 = 170 ' this is where you adjust the forward/backward position for player 3 score
	yoff4 = 170 ' this is where you adjust the forward/backward position for player 4 score
	yoff5 = 170	' this is where you adjust the forward/backward position for credits and ball in play
	zoff = 717
	xrot = -90
...
Sub UpdateMultipleLamps()
	...
	If Controller.Lamp(13) = 0 Then: FlBGL13.visible=0: else: FlBGL13.visible=1 ' Highest Score
	...
	If Controller.Lamp(45) = 0 Then
		VRBGFL45_1.visible = 1
		VRBGFL45_2.visible = 1
		VRBGFL45_3.visible = 1
		VRBGFL45_4.visible = 1
		VRBGFL45_5.visible = 1
		VRBGFL45_6.visible = 1
		VRBGFL45_7.visible = 1
		VRBGFL45_8.visible = 1
		VRBGFL45_9.visible = 1
		VRBGFL45_10.visible = 1
		VRBGFL45_11.visible = 1
	Else 
		VRBGFL45_1.visible = 0
		VRBGFL45_2.visible = 0
		VRBGFL45_3.visible = 0
		VRBGFL45_4.visible = 0
		VRBGFL45_5.visible = 0
		VRBGFL45_6.visible = 0
		VRBGFL45_7.visible = 0
		VRBGFL45_8.visible = 0
		VRBGFL45_9.visible = 0
		VRBGFL45_10.visible = 0
		VRBGFL45_11.visible = 0
	End If

	' Ball in Play
	If Controller.Lamp(29) = 0 Then
