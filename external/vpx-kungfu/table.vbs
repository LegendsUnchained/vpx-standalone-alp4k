' Kung Fu by LTD do Brasil from 1975
...
' Valores Constants
Const TableName = "LTDKungFu" ' file name to save highscores and other variables
Const cGameName = "LTDKungFu" ' B2S name
...
Const Special1 = 39000        ' extra ball or credit
Const Special2 = 59000
...
Sub PopupF_Animate: BallSaverPost.Z = PopupF.CurrentAngle: End Sub
...
Sub EndOfBall()
    ...
    If NOT Tilted Then
        BonusCountTimer.Interval = 150 + 100 * BonusMultiplier
...
Sub BonusCountTimer2_Timer 'count the bonus during the game
    'debug.print "BonusCount2_Timer"
    If Bonus > 0 Then
        Bonus = Bonus -1
        AddScore 1000 * BonusMultiplier
        DigitsUpdate
...
Sub Bumper001_Hit 'left bumper
    ...
    AddScore 10 + 10 * Lbumper1a.State
End Sub

Sub Bumper002_Hit 'center bumper
    If Tilted Then Exit Sub
    PlaySoundAt "fx_bumper", Bumper002
    AddScore 10 + 10 * Lbumper2a.State
End Sub

Sub Bumper003_Hit 'center bumper
    If Tilted Then Exit Sub
    PlaySoundAt "fx_bumper", Bumper003
    AddScore 10 + 10 * Lbumper3a.State
End Sub

Sub Bumper004_Hit 'center bumper
    If Tilted Then Exit Sub
    PlaySoundAt "fx_bumper", Bumper004
    AddScore 10 + 10 * Lbumper4a.State
End Sub
...
Sub CheckTargets 'hit the 5 targets to light extra ball
    If light004.State OR Light002.State Then Exit Sub
...
Sub rlband010_Hit:AddScore 10:End Sub
Sub rlband015_Hit:AddScore 10:End Sub
Sub rlband012_Hit:AddScore 10:End Sub
Sub rlband005_Hit:AddScore 10:End Sub
Sub rlband014_Hit:AddScore 10:End Sub
Sub rlband013_Hit:AddScore 10:End Sub
Sub rlband011_Hit:AddScore 10:End Sub
Sub rlband006_Hit:AddScore 10:End Sub
Sub rlband008_Hit:AddScore 10:End Sub
Sub rlband009_Hit:AddScore 10:End Sub

' Flippers Ball Saver Post

Sub RaisePost
    PlaySoundAt "fx_solenoidOn", BallSaverPost
    PopupF.RotateToStart
    popup.IsDropped = 0
    Light001.State = 1
End Sub

Sub LowerPost
    PlaySoundAt "fx_solenoidOff", BallSaverPost
    PopupF.RotateToEnd
    popup.IsDropped = 1
    Light001.State = 0
End Sub
...
Sub kicker1_Hit
    ...
    If NOT Tilted Then
        ...
        Lbumper4b.State = 1
    End If
    vpmtimer.AddTimer 2000, "PlaySoundAt ""fx_kicker"", Kicker1: kicker1.Kick 170, 18:iron1.rotx = -20 '"
    vpmtimer.addtimer 2300, "iron1.rotx = 0 '"
    k1 = 1
    CheckKickers
End Sub
...
Sub kicker2_Hit
    ...
    If NOT Tilted Then
        ...
        Lbumper3b.State = 1
    End If
    vpmtimer.AddTimer 2000, "PlaySoundAt ""fx_kicker"", Kicker2: kicker2.Kick 190, 18:iron2.rotx = -20 '"
    vpmtimer.addtimer 2300, "iron2.rotx = 0 '"
    k2 = 1
    CheckKickers
End Sub
...
Sub kicker3_Hit
    ...
    If NOT Tilted Then
        ...
        Addscore 500
    End If
    vpmtimer.AddTimer 2000, "PlaySoundAt ""fx_kicker"", Kicker3: kicker3.Kick 0, 35 '"
    k3 = 1
    CheckKickers
End Sub
