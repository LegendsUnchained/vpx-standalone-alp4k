...
Set vpmShowDips = GetRef("editDips")
	...
	Sub table1_Exit:SaveLUT
         Controller.Games(cGameName).Settings.Value("sound")=1
         Controller.Games("pnkpnthr").Settings.Value("dmd_red") = 255 
         Controller.Games("pnkpnthr").Settings.Value("dmd_green") = 88
         Controller.Games("pnkpnthr").Settings.Value("dmd_blue") = 32
         Controller.Stop
    End Sub
...
'**********************************
'Game Boot Music Timer

Sub GB01_timer
    Playsound("0PP00")
    GB01.enabled=False
    AM01.interval=100000:AM01.enabled=True
End Sub
...
Sub AM01_Timer
    ...
    aa = INT(3 * RND(1) )
    Select Case aa
    Case 0:PlaySound"0PP05":AM02.interval=100000:AM02.enabled=True
    Case 1:PlaySound"0PP06":AM02.interval=63000:AM02.enabled=True
    Case 2:PlaySound"0PP07":AM02.interval=36000:AM02.enabled=True
    End Select
    AM01.enabled=False
End Sub
...
Sub AM02_Timer
    ...
    ab = INT(3 * RND(1) )
    Select Case ab
    Case 0:PlaySound"0PP00":AM01.interval=100000:AM01.enabled=True
    Case 1:PlaySound"0PP04":AM01.interval=95000:AM01.enabled=True
    Case 2:PlaySound"0PP06a":AM01.interval=58000:AM01.enabled=True
    End Select
    AM02.enabled=False
End Sub
...
Sub CI01_Timer
    ...
    ac = INT(5 * RND(1) )
    Select Case ac
    Case 0:PlaySound"0PP21"
    Case 1:PlaySound"0PP10"
    Case 2:PlaySound"0PP11"
    Case 3:PlaySound"0PP12"
    Case 4:PlaySound"0PP13"
    End Select
    CI01.enabled=False
End Sub
...
Sub PS01_Timer
    ...
    am01.enabled=False
    am02.enabled=False
    am01.enabled=True:AM01.interval=5000
End Sub
...
' Ball Release into Plungerlane Trigger
Sub Gate2_Hit():
     If RK=1 And LK=1 Then MBA=1:BIP=0:PRF=0:StopPPSounds:IGM01.enabled=False:IGM02.enabled=False:PlaySound"0PP04":IGM01.interval=85000:IGM01.enabled=True:Exit Sub:End If
     If RK=1 And KD=0 Or LK=1 And KD=0 Then BIP=0:PRF=0:am01.enabled=False:Exit Sub:End If
     BIP=1
     PRF=0
     KD=0
     am01.enabled=False
...
Sub Trigger001_Hit()
    If BIP=1 Then 
     ...
     ad = INT(3 * RND(1) )
     Select Case ad
     Case 0:PlaySound("0PP01"):IGM02.interval=81200:IGM02.enabled=True
     Case 1:PlaySound("0PP02"):IGM02.interval=105800:IGM02.enabled=True
     Case 2:PlaySound("0PP03"):IGM02.interval=64000:IGM02.enabled=True
     End Select
    Else 
     PRF=0
    End If
...
Sub Gate_unHit:PRF=1:End Sub

'**********************************
'Plungerlane Attract Timers

Sub PA01_Timer
    PlaySound"0PP00a":PA02.interval=15500:PA02.enabled=True
    PA01.enabled=False
End Sub
...
Sub PA02_Timer
    ...
    ae = INT(2 * RND(1) )
    Select Case ae
    Case 0:PlaySound"0PP22":PlaySound"0PP00a":PA03.interval=15500:PA03.enabled=True
    Case 1:PlaySound"0PP23":PlaySound"0PP00a":PA03.interval=15500:PA03.enabled=True
    End Select
    PA02.enabled=False
End Sub

Sub PA03_Timer
    PlaySound"0PP24":PlaySound"0PP00a":PA02.interval=15500:PA02.enabled=True
    PA03.enabled=False
End Sub
...
Sub IGM02_Timer
    ...
    ag = INT(3 * RND(1) )
    Select Case ag
    Case 0:PlaySound("0PP01"):IGM01.interval=81200:IGM01.enabled=True
    Case 1:PlaySound("0PP02"):IGM01.interval=105800:IGM01.enabled=True
    Case 2:PlaySound("0PP03"):IGM01.interval=64000:IGM01.enabled=True
    End Select
    IGM02.enabled=False
End Sub
...
Dim MBA 'Multi-Ball Active
Dim MBC 'Multi-Ball Count
MBA=0
MBC=0

Sub DR01_Timer
    If RK=1 Or LK=1 Then KD=1:End If
    If l11.state=1 Then DR01.enabled=False:KD=0: Exit Sub: End If
    If MBA=1 then MBC=MBC+1:If MBC<3 then PlaySound"0PP09":DR01.enabled=False:If MBC=2 then StopPPSounds:IGM01.enabled=False:IGM02.enabled=False:IGM01.enabled=True:Exit sub:End If
    StopPPSounds:IGM01.enabled=False:IGM02.enabled=False:AM01.interval=15000:AM01.enabled=True
    PlaySound"0PP08"
    MBA=0:MBC=0
    DR01.enabled=False
End Sub

'Drop Target FX Timer

Sub DT01_Timer
    Dim ah
    ah = INT(2 * RND(1) )
    Select Case ah
    Case 0:PlaySound("0PP12")
    Case 1:PlaySound("0PP15")
    End Select
    DT01.enabled=False
End Sub
...
Sub BU01_Timer
    ...
    ai = INT(2 * RND(1) )
    Select Case ai
	Case 0:StopSound"0PP13":StopSound"0PP14":PlaySound"0PP13"
	Case 1:StopSound"0PP13":StopSound"0PP14":PlaySound"0PP14"
    End Select
    BU01.enabled=False
End Sub

'Wire Rollover FX Timer
Sub WR01_Timer
    Dim aj
    aj = INT(5 * RND(1) )
    Select Case aj
	Case 0:StopSound"0PP16":StopSound"0PP17":StopSound"0PP18":StopSound"0PP19":StopSound"0PP20":PlaySound"0PP16"
	Case 1:StopSound"0PP16":StopSound"0PP17":StopSound"0PP18":StopSound"0PP19":StopSound"0PP20":PlaySound"0PP17"
	Case 2:StopSound"0PP16":StopSound"0PP17":StopSound"0PP18":StopSound"0PP19":StopSound"0PP20":PlaySound"0PP18"
	Case 3:StopSound"0PP16":StopSound"0PP17":StopSound"0PP18":StopSound"0PP19":StopSound"0PP20":PlaySound"0PP19"
	Case 4:StopSound"0PP16":StopSound"0PP17":StopSound"0PP18":StopSound"0PP19":StopSound"0PP20":PlaySound"0PP20"
    End Select
    WR01.enabled=False
End Sub

'Lower Right Saucer FX Timer
Sub CK01_Timer
    Dim ak
    ak = INT(7 * RND(1) )
    Select Case ak
    Case 0:PlaySound"0PP22a"
    Case 1:PlaySound"0PP22b"
    Case 2:PlaySound"0PP22c"
    Case 3:PlaySound"0PP23a"
    Case 4:PlaySound"0PP23b"
    Case 5:PlaySound"0PP23c"
    Case 6:PlaySound"0PP23d"
    End Select
    CK01.enabled=False
End Sub