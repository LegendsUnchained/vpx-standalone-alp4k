...
Const cGameName="elektra",UseSolenoids=2,UseLamps=1,UseGI=0,SSolenoidOn="SolOn",SSolenoidOff="SolOff",SFlipperOn="fx_Flipperup",SFlipperOff="fx_Flipperdown"
Const SCoin="coin"
...
If MusicOption1 = 1 then
   If musicNum = 0 Then PlayMusic "/jekylhyde - Code 3 - En Route.mp3" End If
   If musicNum = 1 Then PlayMusic "/jekylhyde - Cold Corridors.mp3" End If
   If musicNum = 2 Then PlayMusic "/jekylhyde - Crude Contraption.mp3" End If
   If musicNum = 3 Then PlayMusic "/jekylhyde - Descent to Doom.mp3" End If
   If musicNum = 4 Then PlayMusic "/jekylhyde - Fire Seems to Work.mp3" End If
   If musicNum = 5 Then PlayMusic "/jekylhyde - Hide and Seek.mp3" End If
   If musicNum = 6 Then PlayMusic "/jekylhyde - Lurking in the Dark.mp3" End If
   If musicNum = 7 Then PlayMusic "/jekylhyde - One Eight Four - On-Scene.mp3" End If
   If musicNum = 8 Then PlayMusic "/jekylhyde - Retrieval.mp3" End If
   If musicNum = 9 Then PlayMusic "/jekylhyde - Them.mp3" End If
...
Sub RandomTrack
   Dim m
   m = INT(10 * RND(1) )
   If m = 0 Then PlayMusic "/jekylhyde - Code 3 - En Route.mp3" End If
   If m = 1 Then PlayMusic "/jekylhyde - Cold Corridors.mp3" End If
   If m = 2 Then PlayMusic "/jekylhyde - Crude Contraption.mp3" End If
   If m = 3 Then PlayMusic "/jekylhyde - Descent to Doom.mp3" End If
   If m = 4 Then PlayMusic "/jekylhyde - Fire Seems to Work.mp3" End If
   If m = 5 Then PlayMusic "/jekylhyde - Hide and Seek.mp3" End If
   If m = 6 Then PlayMusic "/jekylhyde - Lurking in the Dark.mp3" End If
   If m = 7 Then PlayMusic "/jekylhyde - One Eight Four - On-Scene.mp3" End If
   If m = 8 Then PlayMusic "/jekylhyde - Retrieval.mp3" End If
   If m = 9 Then PlayMusic "/jekylhyde - Them.mp3" End If
...
'Stand Up Targets
Sub SW29_Hit : vpmTimer.PulseSwitch 29, 0, 0 : playsound"popper" End Sub
Sub SW30_Hit : vpmTimer.PulseSwitch 30, 0, 0 : playsound"popper" End Sub
Sub SW31_Hit : vpmTimer.PulseSwitch 31, 0, 0 : playsound"popper" End Sub
Sub SW33_Hit : vpmTimer.PulseSwitch 33, 0, 0 : playsound"rollover" End Sub
Sub SW34_Hit : vpmTimer.PulseSwitch 34, 0, 0 : playsound"rollover" End Sub
Sub SW35_Hit : vpmTimer.PulseSwitch 35, 0, 0 : playsound"rollover" End Sub
Sub SW36_Hit : vpmTimer.PulseSwitch 36, 0, 0 : playsound"rollover" End Sub
Sub SW37_Hit : vpmTimer.PulseSwitch 37, 0, 0 : playsound"rollover" End Sub
...
Sub RollingTimer_Timer()
    ...
    For b = 0 to UBound(BOT)
        If BallVel(BOT(b) ) > 1 AND BOT(b).z < 180 Then
            rolling(b) = True
...
BallShadow = Array (BallShadow1,BallShadow2,BallShadow3,BallShadow4,BallShadow5,BallShadow6)
    ...
    For b = 0 to UBound(BOT)
        ...
        If BOT(b).Z > 20 and BOT(b).Z < 180 Then
