...
'							TABLE OPTIONS
'************************************************************************
Const VaultEdition = 1				'Show new lower pf plate, LED flashers, apron stickers and DMD decal, these were added in the Vault Edition models produced in 2017
Const NudeMod = 1					'Enable Nude Mod, with new artwork (0= no, 1= yes)
...
Const LaserMod = 1					'Shows a laser beam when Cannon is moving (0= no, 1= yes)
...
Const SideCabDecals = 2				'0 - Standard Black Wooden Sideblades, 1 - Custom Fire Sideblades, 2 - Custom Decal Sideblades 
...
Sub ACDC_KeyDown(ByVal Keycode)
	...
	If KeyCode = PlungerKey OR KeyCode = LockbarKey Then Controller.Switch(64)=1 :PushButton_002.Z =PushButton_002.Z -6	:PushButton_001.Z =PushButton_001.Z -6		'FIRE Button, mapped to the right magna save
...
Sub ACDC_KeyUp(ByVal Keycode)
	...
	If KeyCode = PlungerKey OR KeyCode = LockbarKey Then Controller.Switch(64)=0 :PushButton_002.Z =PushButton_002.Z +6				'FIRE Button, mapped to the right magna save
