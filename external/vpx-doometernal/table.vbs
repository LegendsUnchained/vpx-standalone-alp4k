...
Const MaxOrbitLevel = 10 'Doomslayer letters.
Const MaxOrbitAwardLevel = 9 '9 different Doomslayer awards.
...
'/////////////////////////////  TEST THINGS WITH MAGNASAVE BUTTONS  ////////////////////////////

    If Keycode = RightMagnaSave Then SELECTMODE
    If Keycode = LeftMagnaSave Then SELECTMODE
...
Sub AwardSpecial()
	...
	FLASHEFFECT(4)
	PlaySoundAtLevelStatic ("VO_Replay"), VoiceOverSoundLevel, BULB_DS_6
End Sub
...
Sub AwardDoomSkillshot()
    ResetSkillShotTimer_Timer
    DMD CL("DOOM SKILLSHOT"), CL(FormatScore(DoomSkillshotValue(CurrentPlayer))), "d_border", eNone, eBlinkFast, eNone, 2000, True, ""
...
Sub AwardDoom()
    DMD CL("DOOM AWARD"), CL(FormatScore(DoomValue(CurrentPlayer))), "d_border", eNone, eBlinkFast, eNone, 2000, True, ""
...
Sub ShowTableInfo
    ...
    Else
        ...
        End If
    End If
    DMD "        PIXEL.FI", "          PRESENTS", "d_pixelfipresents", eNone, eNone, eNone, 2000, False, ""
...
'/////////////////////////////  RENDER THE SHADOW FOR EACH BALL  ////////////////////////////
    ...
    For b = 0 to UBound(BOT)
        If BOT(b).X < Fluffy.Width/2 Then
            BallShadow(b).X = ((BOT(b).X) - (Ballsize/6) + ((BOT(b).X - (Fluffy.Width/2))/7)) + 6
        Else
            BallShadow(b).X = ((BOT(b).X) + (Ballsize/6) + ((BOT(b).X - (Fluffy.Width/2))/7)) - 6
        End If
...
FlInitBumper 1, "PURPLE" : FlInitBumper 2, "PURPLE" : FlInitBumper 3, "PURPLE" 
...
Sub RandomSoundJackpot()
	Select Case Int(Rnd*3)+1
		Case 1 : PlaySoundAtLevelStatic ("VO_Jackpot_1"), VoiceOverSoundLevel, BULB_DS_6
...
Sub RandomSoundMultiball()
	Select Case Int(Rnd*4)+1
		Case 1 : PlaySoundAtLevelStatic ("VO_Multiball_1"), VoiceOverSoundLevel, BULB_DS_6
...
Sub RandomSoundSuperJackpot()
	Select Case Int(Rnd*4)+1
		Case 1 : PlaySoundAtLevelStatic ("VO_Super_Jackpot_1"), VoiceOverSoundLevel, BULB_DS_6
...
Sub RandomSoundPlayerJoins()
	Select Case Int(Rnd*11)+1
		...
		Case 4 : PlaySoundAtLevelStatic ("VO_Player_Joins_4"), VoiceOverSoundLevel, BULB_DS_6
		Case 5 : PlaySoundAtLevelStatic ("VO_Player_Joins_5"), VoiceOverSoundLevel, BULB_DS_6
		Case 6 : PlaySoundAtLevelStatic ("VO_Player_Joins_6"), VoiceOverSoundLevel, BULB_DS_6
		Case 7 : PlaySoundAtLevelStatic ("VO_Player_Joins_7"), VoiceOverSoundLevel, BULB_DS_6
		Case 8 : PlaySoundAtLevelStatic ("VO_Player_Joins_8"), VoiceOverSoundLevel, BULB_DS_6
		Case 9 : PlaySoundAtLevelStatic ("VO_Player_Joins_9"), VoiceOverSoundLevel, BULB_DS_6
		Case 10 : PlaySoundAtLevelStatic ("VO_Player_Joins_10"), VoiceOverSoundLevel, BULB_DS_6
		Case 11 : PlaySoundAtLevelStatic ("VO_Player_Joins_11"), VoiceOverSoundLevel, BULB_DS_6
	End Select
End Sub
...
Sub ChangeRandomSong
	Select Case Int(Rnd*9)+1
		Case 1:
			If Song = "MU_01_ATDOOMSGATE" Then
				ChangeRandomSong
			Else
				PlaySong "MU_01_ATDOOMSGATE"
			End If
		Case 2:
			If Song = "MU_02_KITCHENACE" Then
				ChangeRandomSong
			Else
				PlaySong "MU_02_KITCHENACE"
			End If
		Case 3:
			If Song = "MU_03_ONTHEHUNT" Then
				ChangeRandomSong
			Else
				PlaySong "MU_03_ONTHEHUNT"
			End If
		Case 4:
			If Song = "MU_04_HIDINGTHESECRETS" Then
				ChangeRandomSong
			Else
				PlaySong "MU_04_HIDINGTHESECRETS"
			End If
		Case 5:
			If Song = "MU_05_ISAWEDTHEDEMONS" Then
				ChangeRandomSong
			Else
				PlaySong "MU_05_ISAWEDTHEDEMONS"
			End If
		Case 6:
			If Song = "MU_06_UNTITLED" Then
				ChangeRandomSong
			Else
				PlaySong "MU_06_UNTITLED"
			End If
		Case 7:
			If Song = "MU_07_DONNATOTHERESCUE" Then
				ChangeRandomSong
			Else
				PlaySong "MU_07_DONNATOTHERESCUE"
			End If
		Case 8:
			If Song = "MU_08_DEEPINTOTHECODE" Then
				ChangeRandomSong
			Else
				PlaySong "MU_08_DEEPINTOTHECODE"
			End If
		Case 9:
			If Song = "MU_09_FACINGTHESPIDER" Then
				ChangeRandomSong
			Else
				PlaySong "MU_09_FACINGTHESPIDER"
			End If
	End Select
End Sub
...
Sub AddOrbitAwardLevel(q)
	...
	Else
        ...
        DMD CL("DOOMSLAYER AWARD"), CL("250000"), "_", eNone, eBlink, eNone, 3000, True, ""
    End If
End Sub
...
Sub AddOrbitAward(Level)
    Select Case Level
            Case 1: DMD CL("DOOMSLAYER AWARD"), CL("2 X SPINNERS"), "_", eNone, eBlink, eNone, 3000, True, "" : SpinnerMultiplier(CurrentPlayer) = 2
            Case 2: DMD CL("DOOMSLAYER AWARD"), CL("2 X ORBITS"), "_", eNone, eBlink, eNone, 3000, True, "" : OrbitMultiplier(CurrentPlayer) = 2
            Case 3: DMD CL("DOOMSLAYER AWARD"), CL("2 X BUMPERS"), "_", eNone, eBlink, eNone, 3000, True, "" : BumperMultiplier(CurrentPlayer) = 2
            Case 4: DMD CL("DOOMSLAYER AWARD"), CL("3 X SPINNERS"), "_", eNone, eBlink, eNone, 3000, True, "" : SpinnerMultiplier(CurrentPlayer) = 3
            Case 5: DMD CL("DOOMSLAYER AWARD"), CL("3 X ORBITS"), "_", eNone, eBlink, eNone, 3000, True, "" : OrbitMultiplier(CurrentPlayer) = 3
            Case 6: DMD CL("DOOMSLAYER AWARD"), CL("3 X BUMPERS"), "_", eNone, eBlink, eNone, 3000, True, "" : BumperMultiplier(CurrentPlayer) = 3
            Case 7: DMD CL("DOOMSLAYER AWARD"), CL("4 X SPINNERS"), "_", eNone, eBlink, eNone, 3000, True, "" : SpinnerMultiplier(CurrentPlayer) = 4
            Case 8: DMD CL("DOOMSLAYER AWARD"), CL("4 X ORBITS"), "_", eNone, eBlink, eNone, 3000, True, "" : OrbitMultiplier(CurrentPlayer) = 4
            Case 9: DMD CL("DOOMSLAYER AWARD"), CL("4 X BUMPERS"), "_", eNone, eBlink, eNone, 3000, True, "" : BumperMultiplier(CurrentPlayer) = 4
    End Select
End Sub
