...
'        bsTrough.InitExitSnd SoundFX("ballrelease",DOFContactors), SoundFX("Solenoid",DOFContactors)
    ...
    Set bsKicker=New cvpmBallStack
        bsKicker.InitSaucer sw29,29,152,27
...
Set Lights(11) = Light11 ' Not used ? - Thalamus

'Set Lights(12) = Light12
Lights(12)=array(Light12,Light12a)


'Set Lights(13) = Light13 ' High score to date ? - Thalamus
...
'Set Lights(25) = Light25 ' Thalamus

Lights(26)=array(Light26,Light26a)
'Set Lights(27) = Light27 ' Thalamus

'Set Lights(28) = Light28
Lights(28)=array(Light28,Light28a)

'Set Lights(29) = Light29 ' Thalamus
...
'Set Lights(41) = Light41 ' Thalamus
Lights(42)=array(Light42,Light42a)
'Set Lights(43) = Light43 ' Thalamus

'Set Lights(44) = Light44
Lights(44)=array(Light44,Light44a)


Set Lights(45) = Light45 ' Turns on - Thalamus
...
Lights(58) = array(Light58,Light58a)

Set Lights(59) = Light59

'Set Lights(60) = Light60
Lights(60)=array(Light60,Light60a)

Set Lights(62) = Light62
'Set Lights(63) = Light63 ' Turns on - Thalamus
...
'	End if
	...
	Else
		Flash28a.visible=0
	End if
	if Light44.State = 1 Then
		Flash44a.visible=1
	Else
		Flash44a.visible=0
	End if
	if GI_13c.State = 1 Then
		Flash58a.visible=1
	Else
		Flash58a.visible=0
	End if
	if Light60.State = 1 Then
		Flash60a.visible=1
	Else
		Flash60a.visible=0
	End if
