' Taito's Gemini 2000 / IPD No. 4579 / 1982 / 4 Players
' VPX8 - version by JPSalas 2024, version 5.5.1
Option Explicit
Randomize
...
Dim bsTrough,dtC,dtR,dtT,cbCaptive, plungerIM, x

Const cGameName = "gemini"
...
'NVramPatchLoad
    ...
    With Controller
        ...
        .SplashInfoLine = "Gemini 2000 - Taito 1982" & vbNewLine & "VPX table by JPSalas v.5.5.1"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
	...
	cbCaptive.InitCaptive CapTrigger1,CapWall1,Capkicker1,0
	cbCaptive.Start
	...
	dtC.InitDrop Array(sw43,sw53,sw63,sw73),Array(43,53,63,73)
	dtC.InitSnd SoundFX("fx_droptarget", DOFDropTargets), SoundFX("fx_resetdrop", DOFContactors)
	dtC.CreateEvents "dtC"

	Set dtR=New cvpmDropTarget
	dtR.InitDrop Array(sw44,sw54,sw64,sw74),Array(44,54,64,74)
	...
	dtT.InitDrop Array(sw5,sw15,sw25,sw35),Array(5,15,25,35)
    ...
    With plungerIM
        .InitImpulseP sw3, IMPowerSetting, IMTime
        .Random 0.3
        .switch 3
...
' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 72:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper1:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 72:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper2:End Sub
...
Sub sw75_Hit:vpmTimer.PulseSw 75:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
...
Sub sw2b_Hit: vpmTimer.PulseSw 2: End Sub
Sub sw2d_Hit: vpmTimer.PulseSw 2: End Sub
Sub sw2e_Hit: vpmTimer.PulseSw 2: End Sub
Sub sw2f_Hit: vpmTimer.PulseSw 2: End Sub
