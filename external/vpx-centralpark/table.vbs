...
'-  Porting To VPX
'-  completed during Covid 2021 by TGX
'-  2025 Integrated Loserman's script and B2S into download package
'-  to simplify installation..
'-  Rest in peace my friend.It was a pleasure working with you.
'-	Loserman's package contains the work of Editoy and Stat, thank you also for your contributions
...
Sub InitNewBall()
   ...
   SafeSetDisabled R15, 0
   SafeSetDisabled R20, 0
   SafeSetDisabled R30, 0
	BstackStop.IsDropped=false
   SafeSetDisabled R27, 0
   SafeSetDisabled R25, 0
   SafeSetDisabled R34, 0
    LightLS.TimerEnabled=true
End Sub

Sub SafeSetDisabled(ByRef obj, ByVal value)
   On Error Resume Next
   obj.Disabled = value
   Err.Clear
   On Error Goto 0
...
End Sub
 ...
 Sub TiltOn()
    ...
    PlaySound "RESET3"
    SafeSetDisabled R15, 1
    SafeSetDisabled R20, 1
    SafeSetDisabled R30, 1
    SafeSetDisabled R27, 1
    SafeSetDisabled R25, 1
    SafeSetDisabled R34, 1
    BumperOff 1
    BumperOff 4
    BumperOff 2
    BumperOff 3
