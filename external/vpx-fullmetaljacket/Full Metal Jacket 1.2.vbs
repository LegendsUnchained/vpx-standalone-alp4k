...
'Full Metal Jacket Balutito Graphique MOD
...
Const VolBump   = 0.1 ' Bumpers volume.
...
Sub SolLFlipper(Enabled)
     If Enabled Then
         PlaySoundAtVol SoundFX("fx_Flipperup",DOFContactors), LeftFlipper, 1:LF.fire
     Else
...
Sub SolRFlipper(Enabled)
     If Enabled Then
         PlaySoundAtVol SoundFX("fx_Flipperup",DOFContactors), RightFlipper, 1:RF.fire
     Else
...
Controller.Games(cGameName).Settings.Value("dmd_blue")=78
	...
	With Controller 
		...
		.ShowFrame=0
		.Hidden=VarHidden
		.Games("ravena").Settings.Value("sound") = 0
		.Games("ravena").Settings.Value("samples") = 0
...
Sub Bumper2_Hit:VpmTimer.PulseSw 46:PlaySoundAtVol SoundFX("bumper",DOFContactors),Bumper2, VolBump :DOF 103, DOFPulse:End Sub
Sub Bumper3_Hit:VpmTimer.PulseSw 46:PlaySoundAtVol SoundFX("bumper",DOFContactors),Bumper3, VolBump :DOF 102, DOFPulse:End Sub	
Sub Bumper4_Hit:VpmTimer.PulseSw 46:PlaySoundAtVOl SoundFX("bumper",DOFContactors),Bumper4, VolBump :DOF 104, DOFPulse:End Sub	
...
sub FlipperTimer_Timer()
	...
	FlipperL.rotz = LeftFlipper.currentangle  + 235
	FlipperR.rotz = RightFlipper.currentangle + 125
...
Sub Table1_Exit()
    ...
    Controller.Games("cGameName").Settings.Value("samples") = 1
End Sub