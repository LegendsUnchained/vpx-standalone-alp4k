...
- Add your personalized launcher.elf and rename it to vpx-elbueno.elf
- Download the table and directb2s versions listed above, extract (if necessary) and copy them into the external/vpx-elbueno folder
- Make sure (.vpx), (.directb2s) and (.ini) files are all named the same
- Place eldorado.zip in the external/vpx-elbueno/pinmame/roms folder. DO NOT UNZIP!  
