...
'NVramPatchLoad
    ...
    With Controller
        ...
        .SplashInfoLine = "Airwolf (TBA 2020)" & vbNewLine & "VPX table by IVANTBA"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
PlaySound "Intro",-0
    ...
    bsLeftSaucer.InitExitSnd SoundFX("fx_kicker2", DOFContactors), SoundFX("fx_Solenoid", DOFContactors)
...
Sub MusicOn
    ...
    x = INT(7 * RND(1) )
    Select Case x
       Case 0:PlayMusic "Airwolf - Theme Synthwave Remix.mp3"
       Case 1:PlayMusic "Airwolf (Theme)  1984.mp3"
       Case 2:PlayMusic "Airwolf HD theme music Type A 2015.mp3"
       Case 3:PlayMusic "Airwolf Theme - Extended [ HD ].mp3"
       Case 4:PlayMusic "Airwolf Theme (Cryocon Synthwave Rework).mp3"
       Case 5:PlayMusic "Airwolf Theme Song - Original Intro [Remastered].mp3"
	   Case 6:PlayMusic "Airwolf Theme (Synthwave Remix) Mr McNoggin.mp3"
    End Select
 End Sub
...
Sub Bumper2_Hit:vpmTimer.PulseSw 44:PlaySoundAt SoundFX("fx_bumper2", DOFContactors), Bumper2:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 64:PlaySoundAt SoundFX("fx_bumper3", DOFContactors), Bumper3:End Sub

' Drain & Saucers
Sub Drain_Hit:PlaysoundAt "fx_drain", Drain:bsTrough.AddBall Me:End Sub
Sub sw2_Hit:PlaysoundAt "fx_kicker_enter", sw2:bsTopSaucer.AddBall 0:End Sub
Sub sw3_Hit:PlaysoundAt "fx_kicker_enter2", sw3:bsLeftSaucer.AddBall 0:End Sub

' Rollovers
Sub sw33_Hit:Controller.Switch(33) = 1:PlaySoundAt "fx_sensor", sw33:End Sub
Sub sw33_UnHit:Controller.Switch(33) = 0:End Sub

Sub sw53_Hit:Controller.Switch(53) = 1:PlaySoundAt "fx_sensor2", sw53:End Sub
Sub sw53_UnHit:Controller.Switch(53) = 0:End Sub

Sub sw52_Hit:Controller.Switch(52) = 1:PlaySoundAt "fx_sensor3", sw52:End Sub
Sub sw52_UnHit:Controller.Switch(52) = 0:End Sub

Sub sw62_Hit:Controller.Switch(62) = 1:PlaySoundAt "fx_sensor4", sw62:End Sub
Sub sw62_UnHit:Controller.Switch(62) = 0:End Sub

Sub sw63_Hit:Controller.Switch(63) = 1:PlaySoundAt "fx_sensor5", sw63:End Sub
Sub sw63_UnHit:Controller.Switch(63) = 0:End Sub

Sub sw43_Hit:Controller.Switch(43) = 1:PlaySoundAt "fx_sensor6", sw43:End Sub
Sub sw43_UnHit:Controller.Switch(43) = 0:End Sub

Sub sw12_Hit:Controller.Switch(12) = 1:PlaySoundAt "fx_sensor7", sw12:End Sub
Sub sw12_UnHit:Controller.Switch(12) = 0:End Sub

Sub sw22_Hit:Controller.Switch(22) = 1:PlaySoundAt "fx_sensor8", sw22:End Sub
Sub sw22_UnHit:Controller.Switch(22) = 0:End Sub

Sub sw32_Hit:Controller.Switch(32) = 1:PlaySoundAt "fx_sensor9", sw32:End Sub
Sub sw32_UnHit:Controller.Switch(32) = 0:End Sub

Sub sw42_Hit:Controller.Switch(42) = 1:PlaySoundAt "fx_sensor10", sw42:End Sub
Sub sw42_UnHit:Controller.Switch(42) = 0:End Sub

Sub sw13_Hit:Controller.Switch(13) = 1:PlaySoundAt "fx_sensor11", sw13:lisw13.Duration 1, 600, 0:End Sub
Sub sw13_UnHit:Controller.Switch(13) = 0:End Sub

Sub sw23_Hit:Controller.Switch(23) = 1:PlaySoundAt "fx_sensor12", sw23:lisw23.Duration 1, 600, 0:End Sub
Sub sw23_UnHit:Controller.Switch(23) = 0:End Sub

' Droptargets (only sound effect)
Sub sw4_Hit:PlaySoundAt SoundFX("fx_droptarget", DOFDropTargets), sw4:End Sub
Sub sw14_Hit:PlaySoundAt SoundFX("fx_droptarget2", DOFDropTargets), sw14:End Sub
Sub sw24_Hit:PlaySoundAt SoundFX("fx_droptarget3", DOFDropTargets), sw24:End Sub
Sub sw34_Hit:PlaySoundAt SoundFX("fx_droptarget4", DOFDropTargets), sw34:End Sub
...
Sub sw21_Hit:vpmTimer.PulseSw 21:PlaySoundAtBall SoundFX("fx_target2", DOFDropTargets):End Sub
Sub sw31_Hit:vpmTimer.PulseSw 31:PlaySoundAtBall SoundFX("fx_target3", DOFDropTargets):End Sub
