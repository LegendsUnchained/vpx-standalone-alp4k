' Zarza / Taito / IPD No. 4584 / 1982 / 4 Players
...
Dim bsTrough, dtbank1, bsTopSaucer, bsLeftSaucer, x

Const cGameName = "zarza"
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Zarza - Taito 1982" & vbNewLine & "VPX table by JPSalas v5.5.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
    ...
    bsTopSaucer.InitSaucer sw2, 2, 170, 15
    ...
    bsLeftSaucer.InitSaucer sw3, 3, 100, 15
    ...
    dtbank1.InitDrop Array(sw41, sw51, sw61, sw71), Array(41, 51, 61, 71)
...
Sub rlband003_Timer
    Select Case Rub1
        Case 1:r3.Visible = 0:r6.Visible = 1:rlband003.TimerEnabled = 1
        Case 2:r6.Visible = 0:r7.Visible = 1
        Case 3:r7.Visible = 0:r3.Visible = 1:rlband003.TimerEnabled = 0
    End Select
    Rub1 = Rub1 + 1
End Sub
...
Sub rlband008_Timer
    Select Case Rub2
        Case 1:r4.Visible = 0:r8.Visible = 1:rlband008.TimerEnabled = 1
        Case 2:r8.Visible = 0:r10.Visible = 1
        Case 3:r10.Visible = 0:r4.Visible = 1:rlband008.TimerEnabled = 0
    End Select
    Rub2 = Rub2 + 1
End Sub
...
' Spinner
Sub sw53_Spin:vpmTimer.PulseSw 53:PlaySoundAt "fx_spinner", sw53:End Sub

' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 23:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper1:End Sub
...
Sub Bumper4_Hit:vpmTimer.PulseSw 43:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper4:End Sub
...
Sub sw44_Hit:Controller.Switch(44) = 1:PlaySoundAt "fx_sensor", sw44:rol1.Duration 1, 600, 0:End Sub
Sub sw44_UnHit:Controller.Switch(44) = 0:End Sub

Sub sw54_Hit:Controller.Switch(54) = 1:PlaySoundAt "fx_sensor", sw54:rol2.Duration 1, 600, 0:End Sub
Sub sw54_UnHit:Controller.Switch(54) = 0:End Sub

Sub sw64_Hit:Controller.Switch(64) = 1:PlaySoundAt "fx_sensor", sw64:rol3.Duration 1, 600, 0:End Sub
Sub sw64_UnHit:Controller.Switch(64) = 0:End Sub

Sub sw74_Hit:Controller.Switch(74) = 1:PlaySoundAt "fx_sensor", sw74:rol4.Duration 1, 600, 0:End Sub
...
Sub sw51_Hit:PlaySoundAt SoundFX("fx_droptarget", DOFDropTargets), sw51:End Sub
Sub sw61_Hit:PlaySoundAt SoundFX("fx_droptarget", DOFDropTargets), sw61:End Sub
Sub sw71_Hit:PlaySoundAt SoundFX("fx_droptarget", DOFDropTargets), sw71:End Sub
...
SolCallback(6) = "dtbank1.SolHit 4,"
SolCallback(7) = "dtbank1.SolHit 3,"
SolCallback(8) = "dtbank1.SolHit 2,"
SolCallback(9) = "dtbank1.SolHit 1,"
