...
'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX 
    ...
    Audiovol = 95 'set the volme you'd like for the audio FX
...
'	Dim PuPlayer 
    ...
    '********************************************************************************
			...
			Const pDMD=1
      Const pBackglass=2		'change this number to the screen of your choosing for Topper		
			Const pPlayfield=3
			Const pMusic=4
...
Sub EightBitSuperJackpotTrigger_Hit
    AwardExtraBall
    EightBitAllDropped
    BonusWaveTargerTimer.Enabled = True
    EightBitKillTimer001.Enabled = True
    EightBitCatchTarget.Isdropped = 0
    blockerCatchTarget.Isdropped = 0
...
Sub BonusWaveTargerTimer_Timer 'in timer options look at the interval, its 2500 2 1/2 seconds
    BonusWaveTargerTimer.Enabled = False 'after 2 1/2 seconds Timer1 stops and finishes the Sub
    ControllerTarget002.Isdropped = 1
  End Sub
