...
| **B2S** | Included in vpx pack (not required)| | |
...
## B2S file is not required. I have included a backglass image that stabilizes the fps.
...
- Add the .png,.vpx,.ini to the appropriate postions
