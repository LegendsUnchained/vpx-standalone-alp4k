' Rawhide / IPD No. 3545 / April, 1977 / 4 Players
' Stampede / IPD No. 5232 / February, 1977 / 2 Players
' Stern Electronics, Incorporated, of Chicago, Illinois, USA (1977-1984) [Trade Name: Stern]
' VPX8 table by jpsalas with graphics by Halen
...
' Valores Constants
Const TableName = "Rawhide" ' file name to save highscores and other variables
Const cGameName = "Rawhide" ' B2S name
...
Const Special1 = 152000     ' extra ball or credit
Const Special2 = 176000
Const Special3 = 198000
...
Sub UpdateBonusLights
    Select Case Bonus
        ...
        Case 17:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 1:bl8.State = 0:bl9.State = 0:bl10.State = 1
        Case 18:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 1:bl9.State = 0:bl10.State = 1
    ...
    Select Case Points
        Case 10, 100, 1000
            ...
            If Points = 100 AND(Score(CurrentPlayer) MOD 1000) \ 100 = 0 Then 'new reel 100
                PlaySound SoundFXDOF("chime1000", 132, DOFPulse, DOFChimes)
            ElseIf Points = 10 AND(Score(CurrentPlayer) MOD 100) = 0 Then     'new reel 10
                PlaySound SoundFXDOF("chime100", 132, DOFPulse, DOFChimes)
            Else
                PlaySound SoundFXDOF("chime" &Points, 131, DOFPulse, DOFChimes)
            End If
        Case 20, 30, 40, 50
...
Sub UpdateScore(playerpoints)
    ...
    End If
    If Score(3)> 100000 Then
        TurnON aRollover3
        If B2SOn then
            Controller.B2SSetScoreRolloverPlayer3 1
        end if
    End If
    If Score(4)> 100000 Then
        TurnON aRollover4
        If B2SOn then
...
Sub UpdateBallInPlay 'update backdrop lights
    ...
    Select Case CurrentPlayer
        Case 0:pl1.State = 0:pl2.State = 0:pl3.State = 0:pl4.State = 0
            pl1a.State = 0:pl2a.State = 0:pl3a.State = 0:pl4a.State = 0
        Case 1:pl1.State = 1:pl2.State = 0:pl3.State = 0:pl4.State = 0
            pl1a.State = 1:pl2a.State = 0:pl3a.State = 0:pl4a.State = 0
        Case 2:pl1.State = 0:pl2.State = 1:pl3.State = 0:pl4.State = 0
            pl1a.State = 0:pl2a.State = 1:pl3a.State = 0:pl4a.State = 0
        Case 3:pl1.State = 0:pl2.State = 0:pl3.State = 1:pl4.State = 0
            pl1a.State = 0:pl2a.State = 0:pl3a.State = 1:pl4a.State = 0
        Case 4:pl1.State = 0:pl2.State = 0:pl3.State = 0:pl4.State = 1
            pl1a.State = 0:pl2a.State = 0:pl3a.State = 0:pl4a.State = 1
    End Select
    If B2SOn then
...
Sub AwardExtraBall()
    ' If NOT bExtraBallWonThisBall Then 'only one extra ball can be awarded
    PlaySound SoundFXDOF("fx_knocker", 122, DOFPulse, DOFknocker)
    ExtraBallsAwards(CurrentPlayer) = ExtraBallsAwards(CurrentPlayer) + 1
...
Sub Bumper001_Hit 'left bumper
    ...
    AddScore 100 + 900 * BumperL001.State
End Sub

Sub Bumper002_Hit 'center bumper
    If Tilted Then Exit Sub
    PlaySoundAt "fx_bumper", Bumper002
    AddScore 100 + 900 * BumperL002.State
End Sub
...
Sub Trigger001_Hit
    ...
    If Tilted Then Exit Sub
    AddBonus 1
    If Light002.State Then AwardExtraBall
End Sub
...
Sub Trigger004_Hit
    ...
    If Tilted Then Exit Sub
    AddBonus 1
    If Light003.State Then AwardExtraBall
End Sub
...
Sub Target001_Hit
    ...
    If Tilted Then Exit Sub
    AddScore 500 + 4500 * Light005.State
End Sub

Sub Target002_Hit
    PlaySoundAtBall "fx_target"
    If Tilted Then Exit Sub
    AddScore 500 + 4500 * Light009.State
End Sub
...
Sub ChangeFeature
    Feature = (Feature + 1) MOD 4
    UpdateFeature
End Sub

Sub UpdateFeature
    Select Case Feature
        Case 0:Light012.State = 1:Light013.State = 0:Light014.State = 0:Light015.State = 0
        Case 1:Light012.State = 0:Light013.State = 1:Light014.State = 0:Light015.State = 0
        Case 2:Light012.State = 0:Light013.State = 0:Light014.State = 1:Light015.State = 0
        Case 3:Light012.State = 0:Light013.State = 0:Light014.State = 0:Light015.State = 1
    End Select
End Sub
...
Sub Spinner_Spin
    ...
    If Tilted Then Exit Sub
    AddScore 100 + 900 * Light010.State
End Sub
...
Sub kicker1_Hit
    ...
    If Tilted Then vpmTimer.AddTimer 500, "kickout1 '":Exit Sub
    LitFeature
    Addscore 500 + 4500 * Light016.State
    vpmTimer.AddTimer 1500, "kickout1 '"
End Sub
...
Sub kicker2_Hit
    ...
    If Tilted Then vpmTimer.AddTimer 500, "kickout2 '":Exit Sub
    LitFeature
    Addscore 500 + 4500 * Light011.State
    vpmTimer.AddTimer 1500, "kickout2 '"
End Sub
