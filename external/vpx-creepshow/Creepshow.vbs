...
'CREEPSHOW 1&2 Tribute by Balutito for my friend Jaleco
...
'Option Playfield start with or whithout Billy Boy
Billy. visible = 1 ' 0 = whithou Billy 1 = if you prefer playfield whith Billy for start the game
...
Sub Table1_Init
	...
	On Error Resume Next
		...
		.ShowTitle=0
        .hidden = 0
		.Games("tftc_400").Settings.Value("sound") = 0
		.Games("tftc_400").Settings.Value("samples") = 0
         On Error Resume Next
         .Run GetPlayerHWnd
...
If musicNum = 0 Then PlayMusic "creep1.mp3" End If
If musicNum = 1 Then PlayMusic "creep2.mp3" End If
If musicNum = 2 Then PlayMusic "creep3.mp3" End If
If musicNum = 3 Then PlayMusic "creep4.mp3" End If
If musicNum = 4 Then PlayMusic "creep5.mp3" End If
...
Sub Drain_Hit:bsTrough.addball me : playsoundAtVol"drain",drain,1 : End Sub
 ...
 ' Center Vuk
 Sub sw38a_Hit
     PlaySoundAtVol"breath", ActiveBall, 1
	 bsVuk.AddBall 0
     sw38a.Enabled = 0
	 Me.DestroyBall
 End Sub
...
'Subway to sw52
 ...
 Sub sw54_Hit:PlaySoundAtVol "OCW2",sw54,1:sw54.DestroyBall:vpmTimer.PulseSwitch 54, 100, "HandleTrough":End Sub
Sub TopVUK_Hit:sw53.enabled=0:sw54.enabled=0:end sub
Sub TopVUK_unHit:sw53.enabled=1:sw54.enabled=1:end sub
...
Sub sw55_Hit
	sw55.Enabled = 0
	playsoundAtVol "oil", ActiveBall, 1
...
End Sub
 ...
 Sub sw23_Hit:Controller.Switch(23) = 1:PlaySoundAtVol "HFDay", ActiveBall, VolRol:Billy. visible = 0: End Sub
 ...
 Sub sw31_Hit:Controller.Switch(31) = 1:PlaySoundAtVol "OCW", ActiveBall, VolRol:Billy. visible = 1 : End Sub
...
'Ramp entrance Gate Triggers
 ...
 ' Ramp Triggers
 Sub sw45_Hit:Controller.Switch(45) = 1 : PlaySoundAtVol "paid&laid", ActiveBall, 1:End Sub
 Sub sw45_UnHit:Controller.Switch(45) = 0:End Sub
 Sub sw47_Hit:Controller.Switch(47) = 1 : PlaySoundAtVol "thx ride+", ActiveBall, 1:End Sub
...
Sub Bumper2_Hit : vpmTimer.PulseSw(50) : playsoundAtVol SoundFX("fx_bumper2",DOFContactors), ActiveBall, 1: End Sub
Sub Bumper3_Hit : vpmTimer.PulseSw(51) : playsoundAtVol SoundFX("fx_bumper3",DOFContactors), ActiveBall, 1: End Sub
...
Sub PrimT_Timer
	...
	If rip1.isdropped = false then tombstone.z = 174
    If rip.isdropped = false then tombstone.z = 180
End Sub
...
Sub Table1_Exit()
    Controller.Pause = False
    Controller.Stop
    Controller.Games("tftc_400").Settings.Value("sound") = 1
    Controller.Games("tftc_400").Settings.Value("samples") = 1
End Sub