...
if Tilt = False Then
AddScore100
PlaySoundAt SoundFXDOF("Bumper",119,DOFPulse,DOFContactors), Bumper1
end if
End Sub
...
if Tilt = False Then
AddScore100
PlaySoundAt SoundFXDOF("Bumper",120,DOFPulse,DOFContactors), Bumper2
end if
End Sub
...
if Tilt = False Then
AddScore100
PlaySoundAt SoundFXDOF("Bumper",121,DOFPulse,DOFContactors), Bumper3
end if
End Sub
...
Sub TRani_W_Timer
    Select Case TRStep
        Case 3:TRANI3.Visible = 0
        Case 4:BRani.Visible = 1:TRani_W.TimerEnabled = 0
    End Select
    TRStep = TRStep + 1
End Sub
