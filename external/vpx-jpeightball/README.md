...
- Add your personalized launcher.elf and rename it to `vpx-jpeightball.elf`
- Download the table and directb2s versions listed above, extract (if necessary) and copy them into `vpx-jpeightball` folder
- Place ROM zip file into `vpx-jpeightball/pinmame/roms` folder. DO NOT UNZIP!
