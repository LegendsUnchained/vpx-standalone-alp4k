...
'                 Big Lebowsky Script JPSalas & marty
'                          Version 3.0
' ****************************************************************
...
cPuPPack = ""    ' name of the PuP-Pack / PuPVideos folder for this table
...
Sub KickerHaut_hit()
    KickerHaut.destroyball
    KickerHaut.createball
    KickerHaut.kick 20, 8
End Sub
...
Sub checkglass()
    If Lglass1.state + Lglass2.state + Lglass3.state + Lglass4.state  + Lglass5.state + Lglass6.state = 6 Then
    Kglass1.Enabled = 1
    AddScore 50000
    PlaySound ""
    End IF
...
Sub Kglass1_hit
    Kglass1.destroyball:PlaySound "fx_icecubelong"
    Kglass.createball:PlaySound "fx_icecubelong"
    Timerglass.enabled=1
End Sub

sub Timerglass_timer
	Timerglass.enabled = 0
    Kglass.kick 290, 25, 35:PlaySound "fx_icecubelong":DMD "", "", "dmdbonuswhite" , eBlink, eBlink, eNone, 3000, True, ""
    AddScore 10000
    Kglass1.Enabled = 0
    Lglass.state = 0
    Lglass1.state = 0
...
Sub TbowlingG_hit
    ...
    PlaySound "fx_clock"
    AddScore 5000
    TimerNamebowling.Enabled = 1 
End Sub

Sub TimerNamebowling_timer
    TimerNamebowling.Enabled = 0
    AddScore 15000
    PlaySound "Fx_jackpotchance" : DMD CL("BOWLING"), CL("STRIKE"), "", eBlink, eBlink, eNone, 3000, True, ""
    TbowlingB.Enabled = 1
    lbowlingB.state = 0
    lbowlingO.state = 0
    lbowlingW.state = 0
...
End Sub
 ...
 Wallcasse.collidable = 0
 Tcassecar1.isdropped = 1
 Tcassecar2.isdropped = 1
 Tcassecar3.isdropped = 1
 Tcassecar4.isdropped = 1
...
Sub checkcar()
    If lcar1.state + lcar2.state + lcar3.state + lcar4.state = 4 Then
    Lbowlingcar.state = 2
    wallbas.isdropped = 1
    Timercar.Enabled = 1
    PlaySound "Fx_caracceleration"
    Opencar
    AddScore 10000
    End IF
End Sub
...
Sub Timercar_timer
    Lightcarmode.state = 2 
    Timercar.Enabled = 0   
    car.collidable = 0
    Wallcasse.collidable = 1
    Tcassecar1.isdropped = 0
    Tcassecar2.isdropped = 1
    Tcassecar3.isdropped = 1
    Tcassecar4.isdropped = 1
    lcar1.state = 0
...
Sub Tcassecar1_hit
    Tcassecar1.isdropped = 1:Movecup3
    Wallcasse.collidable = 1
    Tcassecar2.isdropped = 0
    PlaySound "Fx_boom"
    checkcasse
End Sub

Sub Tcassecar2_hit
    Tcassecar2.isdropped = 1:Movecup3
    Wallcasse.collidable = 1
    Tcassecar3.isdropped = 0
    PlaySound "Fx_boom"
    checkcasse
End Sub

Sub Tcassecar3_hit
    Tcassecar3.isdropped = 1:Movecup3
    Wallcasse.collidable = 1
    Tcassecar4.isdropped = 0
    PlaySound "Fx_boom"
    checkcasse
End Sub

Sub Tcassecar4_hit
    Tcassecar4.isdropped = 1:Movecup3
    Wallcasse.collidable = 1
    PlaySound "Fx_boom"
    checkcasse
End Sub
...
Sub checkcasse()
    If Tcassecar1.isdropped + Tcassecar2.isdropped + Tcassecar3.isdropped + Tcassecar4.isdropped = 4 Then
    Lbowlingcar.state = 0
    lgobowling.state = 2
    Lightcarmode.state = 0
    car.collidable = 0
    Walldoor.isdropped = 1
    Wallcasse.collidable =0
    wallbas.isdropped = 0
    Targetcar1.collidable = 0
    Targetcar2.collidable = 0
    AddScore 10000
    Closecar
    PlaySound ""
    End IF
...
sub KbowlingHaut_hit()
    KbowlingHaut.destroyball:PlaySound "fx_dingding"
    Walldoor.isdropped = 0
    lgobowling.state = 0
    Lightcarmode.state = 0
    Kpiste.createball: DisableFlippers False
    Wopenunder.collidable = 0
    Timerbowling.enabled=1
    Targetcar1.collidable = 1
    Targetcar2.collidable = 1
end Sub

sub Timerbowling_timer
	Timerbowling.enabled=0
    Kpiste.kick 65, 10:PlaySound "super-jackpot"
    ChangeBall(5)
    Wopenunder.collidable = 0
    Targetcar.isdropped = 0  :DMD "", "", "dmdcarmode" , eBlink, eBlink, eNone, 3000, True, ""
    AddScore 10000
End Sub

Sub Targetcar_hit
    Targetcar.isdropped = 1 : PlaySoundAt "Fx_caracceleration", Targetcar : DisableFlippers True
    AddScore 50000
    AddMultiball 2
End Sub
...
Sub TargetTapis1_hit
    TargetTapis2.isdropped = 0
    TargetTapis1.collidable = 0
    lightTapis.state =2
    AddScore 10000
    PlaySound "Fx_motorloop"
    rouleau.TransX = -75
    guide.TransY = 75
End Sub

Sub TargetTapis2_hit
    TargetTapis3.isdropped = 0
    TargetTapis2.collidable = 0
    AddScore 10000
    PlaySound "Fx_motorloop"
    rouleau.TransX = -150
    guide.TransY = 150
...
Sub TargetTapis3_hit
    TargetTapis3.collidable = 0
    AddScore 10000
    PlaySound "Fx_motorloop"
    rouleau.TransX = -250
    guide.TransY = 250
...
sub Ktapis_hit
    Ktapis.destroyball:PlaySound "fx_kicker_enter"
    Kpfhaut.createball:DMD "", "", "dmdbonuscarpet" , eBlink, eBlink, eNone, 3000, True, ""
	Timertapis.enabled=1
    TargetTapis1.isdropped = 0
    TargetTapis1.collidable = 1
    TargetTapis2.collidable = 1
    TargetTapis3.collidable = 1
    lightTapis.state =0
    PlaySound "Fx_motorloop"
    rouleau.TransX = 0
    guide.TransY = 0
    PlaySound "Fx_please-go"
...
sub Timertapis_timer
	Timertapis.enabled=0
	Kpfhaut.kick 175, 5
    PlaySound "whereismyball"
end sub
...
Sub TimerdrainPfBas_timer
    TimerdrainPfBas.Enabled = 0
    PyramidKicker.kick 165, 5:PlaySound "fx_kicker_enter"
    ChangeBall(0)
End Sub

Sub drainPfBas_hit()
    TimerdrainPfBas.Enabled = 1
    drainPfBas.destroyball:PlaySound "fx_kicker_enter" : DisableFlippers True
    PyramidKicker.createball 
    quille1.transY = 0
    quille2.transY = 0
    quille3.transY = 0
    quille4.transY = 0
    ...
    quille9.transY = 0
    quille10.transY = 0
    quille1.collidable = 1
    quille2.collidable = 1
    quille3.collidable = 1
    quille4.collidable = 1
    quille5.collidable = 1
    quille6.collidable = 1
    quille7.collidable = 1
    quille8.collidable = 1
    quille9.collidable = 1
    quille10.collidable = 1
    Lquille1.state = 0
    Lquille2.state = 0
    Lquille3.state = 0
    Lquille4.state = 0
    ...
    Twalter.isdropped = 1
    Tdonny.isdropped = 1
    Targetcar.isdropped = 1
end sub

Sub Kcloseunder_hit
    Wopenunder.collidable = 1
    PlaySound ""
End Sub
...
TjesusS.isdropped  = 1
TjesusU.isdropped  = 1
TjesusSa.isdropped  = 1
Kjesus.Enabled  = 0

Sub TjesusJ_hit
    LjesusJ.state = 1:DMD "", "", "dmdjesusJ" , eBlink, eBlink, eNone, 2000, True, ""
    TjesusJ.isdropped  = 1
    TjesusE.isdropped  = 0
...
Sub TjesusE_hit
    LjesusE.state = 1:DMD "", "", "dmdjesusJE" , eBlink, eBlink, eNone, 2000, True, ""
    TjesusE.isdropped  = 1
    TjesusS.isdropped  = 0
    PlaySound "fx_droptarget"
    AddScore 10000
...
Sub TjesusS_hit
    LjesusS.state = 1:DMD "", "", "dmdjesusJES" , eBlink, eBlink, eNone, 2000, True, ""
    TjesusS.isdropped  = 1
    TjesusU.isdropped  = 0
    PlaySound "fx_droptarget"
    AddScore 10000
...
Sub TjesusU_hit
    LjesusU.state = 1:DMD "", "", "dmdjesusJESU" , eBlink, eBlink, eNone, 2000, True, ""
    TjesusU.isdropped  = 1
    TjesusSa.isdropped  = 0
    PlaySound "fx_droptarget"
    AddScore 10000
    checkjesus
End Sub
...
Sub TjesusSa_hit
    LjesusSa.state = 1:DMD "", "", "dmdjesusJESUS" , eBlink, eBlink, eNone, 2000, True, ""
    TjesusSa.isdropped  = 1
    PlaySound "fx_droptarget"
    AddScore 10000
    checkjesus
...
Sub checkjesus()
    If LjesusJ.state + LjesusE.state + LjesusS.state + LjesusU.state + LjesusSa.state = 5 Then
    lightKjesus.state = 2
    AddScore 50000
    PlaySound ""
    Kjesus.Enabled  = 1
    'Tjesus.isdropped = 0:DMD "", "", "dmdJESUSparty" , eBlink, eBlink, eNone, 2500, True, ""
    End IF
End Sub

Sub Kjesus_hit
    Kjesus.destroyball:PlaySound "fx_kicker_enter"
    Kpiste.createball: DisableFlippers False
    Wopenunder.collidable = 0
    Timerjesus.enabled=1
    TjesusJ.isdropped = 0
    TjesusE.isdropped  = 1
    TjesusS.isdropped  = 1
    TjesusU.isdropped  = 1
...
sub Timerjesus_timer
	Timerjesus.enabled=0
    Kpiste.kick 65, 10:PlaySound "super-jackpot"
    ChangeBall(4)
    Wopenunder.collidable = 0
    Tjesus.isdropped = 0 :DMD "", "", "dmdJESUSparty" , eBlink, eBlink, eNone, 2500, True, ""
...
Sub Tjesus_hit
    Tjesus.isdropped = 1 : DisableFlippers True
    Ljesus.state = 1
    Ljesus1.state = 0
    AddScore 50000
    AddMultiball 2
...
Sub TdudeT_hit
    TdudeT.Enabled = 0
    TdudeT1.Enabled = 0
    LdudeT.state = 1:DMD "", "", "dmdt" , eBlink, eBlink, eNone, 2500, True, ""
    TdudeH.Enabled = 1
    AddScore 10000
    PlaySound "Fx_doublereverb"
    checkdude
End Sub

Sub TdudeH_hit
    TdudeH.Enabled = 0
    LdudeH.state = 1:DMD "", "", "dmdth" , eBlink, eBlink, eNone, 2500, True, ""
    TdudeE.Enabled = 1
    AddScore 10000
    PlaySound "Fx_doublereverb"
    checkdude
...
Sub TdudeE_hit
    TdudeE.Enabled = 0
    LdudeE.state = 1:DMD "", "", "dmdthe" , eBlink, eBlink, eNone, 2500, True, ""
    TdudeD.Enabled = 1
    AddScore 10000
    PlaySound "Fx_doublereverb"
    checkdude
...
Sub TdudeD_hit
    TdudeD.Enabled = 0
    LdudeD.state = 1:DMD "", "", "dmdthed" , eBlink, eBlink, eNone, 2500, True, ""
    TdudeU.Enabled = 1
    AddScore 10000
    PlaySound "Fx_doublereverb"
    checkdude
...
Sub TdudeU_hit
    TdudeU.Enabled = 0
    LdudeU.state = 1:DMD "", "", "dmdthedu" , eBlink, eBlink, eNone, 2500, True, ""
    TdudeDa.Enabled = 1
    AddScore 10000
    PlaySound "Fx_doublereverb"
    checkdude
...
Sub TdudeDa_hit
    TdudeDa.Enabled = 0
    LdudeDa.state = 1:DMD "", "", "dmdthedud" , eBlink, eBlink, eNone, 2500, True, ""
    TdudeEa.Enabled = 1
    AddScore 10000
    PlaySound "Fx_doublereverb"
    checkdude
...
Sub TdudeEa_hit
    TdudeEa.Enabled = 0
    LdudeEa.state = 1:DMD "", "", "dmdthedude" , eBlink, eBlink, eNone, 2500, True, ""
    TdudeT1.Enabled = 1
    AddScore 10000
    PlaySound "Fx_doublereverb"
    checkdude
...
Sub checkdude()
    If LdudeT.state + LdudeH.state + LdudeE.state + LdudeD.state + LdudeU.state + LdudeDa.state + LdudeEa.state = 7 Then
    AddScore 50000
    PlaySound "fx_droptarget"
    LowerRamp
    Lrampbowling.state = 2
    Ldude1.state = 2
    LdudeT.state = 0
    LdudeH.state = 0
    LdudeE.state = 0
    ...
    LdudeDa.state = 0
    LdudeEa.state = 0
    Tdude.isdropped = 0:DMD "", "", "dmdthedudeparty" , eBlink, eBlink, eNone, 3000, True, ""
    End IF
End Sub

Sub Kbowling_hit
    Kbowling.destroyball: PlaySound "fx_kicker_enter"
    Kpiste.createball: DisableFlippers False
    Lrampbowling.state = 0
    Wopenunder.collidable = 0
    Timerdude.enabled=1
    Lrampbowling.state = 0
    RiseRamp
...
Sub Tdude_hit
    Tdude.isdropped = 1 : DisableFlippers True
    Ldude.state = 1
    Ldude1.state = 0
    TdudeT.Enabled = 0
    TdudeT1.Enabled = 0
...
Sub TwalterW_hit
    TwalterW.Enabled = 0
    TwalterW1.Enabled = 0
    LwalterW.state = 1:DMD "", "", "dmdw" , eBlink, eBlink, eNone, 2500, True, ""
    TwalterA.Enabled = 1
    AddScore 10000
    PlaySound "fx_dingding"
    checkwalter
End Sub

Sub TwalterA_hit
    TwalterA.Enabled = 0
    LwalterA.state = 1:DMD "", "", "dmdwa" , eBlink, eBlink, eNone, 2500, True, ""
    TwalterL.Enabled = 1
    AddScore 10000
    PlaySound "fx_dingding"
    checkwalter
...
Sub TwalterL_hit
    TwalterL.Enabled = 0
    LwalterL.state = 1:DMD "", "", "dmdwal" , eBlink, eBlink, eNone, 2500, True, ""
    TwalterT.Enabled = 1
    AddScore 10000
    PlaySound "fx_dingding"
    checkwalter
...
Sub TwalterT_hit
    TwalterT.Enabled = 0
    LwalterT.state = 1:DMD "", "", "dmdwalt" , eBlink, eBlink, eNone, 2500, True, ""
    TwalterE.Enabled = 1
    AddScore 10000
    PlaySound "fx_dingding"
    checkwalter
...
Sub TwalterE_hit
    TwalterE.Enabled = 0
    LwalterE.state = 1:DMD "", "", "dmdwalte" , eBlink, eBlink, eNone, 2500, True, ""
    TwalterR.Enabled = 1
    AddScore 10000
    PlaySound "fx_dingding"
    checkdude
...
Sub TwalterR_hit
    TwalterR.Enabled = 0
    LwalterR.state = 1:DMD "", "", "dmdwalter" , eBlink, eBlink, eNone, 2500, True, ""
    TwalterW1.Enabled = 1
    AddScore 10000
    PlaySound "fx_dingding"
    checkwalter
...
Sub checkwalter()
    If LwalterW.state + LwalterA.state + LwalterL.state + LwalterT.state + LwalterE.state + LwalterR.state = 6 Then
    AddScore 50000
    PlaySound "fx_droptarget"
    LowerRamp
    Lrampbowling.state = 2
    ...
    LwalterE.state = 0 
    LwalterR.state = 0
    Twalter.isdropped = 0:DMD "", "", "dmdwalterparty" , eBlink, eBlink, eNone, 3000, True, ""
    End IF
End Sub
...
sub Timerwalter_timer
	Timerwalter.enabled=0
    Kpiste.kick 65, 10:PlaySound "super-jackpot"
    ChangeBall(2)
    Wopenunder.collidable = 0
    AddScore 10000
...
Sub Twalter_hit
    Twalter.isdropped = 1 : DisableFlippers True
    Lwalter.state = 1
    Lwalter1.state = 0
    TwalterW.Enabled = 0
    TwalterW1.Enabled = 0
...
Sub TmaudeM_hit
    TmaudeM.Enabled = 0
    LmaudeM.state = 1 :DMD "", "", "dmdMAUDEM" , eBlink, eBlink, eNone, 2500, True, ""
    TmaudeA.Enabled = 1
    AddScore 10000
...
Sub TmaudeA_hit
    TmaudeA.Enabled = 0
    LmaudeA.state = 1:DMD "", "", "dmdMAUDEMA" , eBlink, eBlink, eNone, 2500, True, ""
    TmaudeU.Enabled = 1
    AddScore 10000
    PlaySound "Fx_level-up"
    checkmaude
...
Sub TmaudeU_hit
    TmaudeU.Enabled = 0
    TmaudeD.Enabled = 1
    LmaudeU.state = 1:DMD "", "", "dmdMAUDEMAU" , eBlink, eBlink, eNone, 2500, True, ""
    AddScore 10000
    PlaySound "Fx_level-up"
    checkmaude
End Sub
...
Sub TmaudeD_hit
    TmaudeD.Enabled = 0
    TmaudeE.Enabled = 1
    LmaudeD.state = 1:DMD "", "", "dmdMAUDEMAUD" , eBlink, eBlink, eNone, 2500, True, ""
    AddScore 10000
    PlaySound "Fx_level-up"
    checkmaude
End Sub
...
Sub TmaudeE_hit
    TmaudeE.Enabled = 0
    'TmaudeM.Enabled = 1
    LmaudeE.state = 1:DMD "", "", "dmdMAUDEMAUDE" , eBlink, eBlink, eNone, 2500, True, ""
    AddScore 10000
    PlaySound "Fx_level-up"
    checkmaude
    PlayQuote
...
Sub checkmaude()
    If LmaudeM.state + LmaudeA.state + LmaudeU.state + LmaudeD.state + LmaudeE.state = 5 Then
    AddScore 50000
    PlaySound "fx_droptarget"
    LowerRamp
    Lrampbowling.state = 2
    ...
    LmaudeE.state = 0
    Lmaude1.state = 2
    Tmaude.isdropped = 0 :DMD "", "", "dmdMAUDEparty1" , eBlink, eBlink, eNone, 3000, True, "" 
    TmaudeM.Enabled = 1
    End IF
End Sub
...
Sub Kbowling_hit
    ...
    Kpiste.createball: DisableFlippers False
    Wopenunder.collidable = 0
    TimerMaude.enabled=1
    Lrampbowling.state = 0
    RiseRamp
End Sub

sub TimerMaude_timer
	TimerMaude.enabled=0
    Kpiste.kick 65, 10:PlaySound "super-jackpot"
    ChangeBall(1)
    Wopenunder.collidable = 0
    Lrampbowling = 0
...
Sub Tmaude_hit
    Tmaude.isdropped = 1 : DisableFlippers True
    Lmaude.state = 1
    Lmaude1.state = 0
    AddScore 50000
    AddMultiball 2
...
Sub TdonnyD_hit
    TdonnyD.enabled = 0
    LdonnyD.state = 1:DMD "", "", "dmdd" , eBlink, eBlink, eNone, 2500, True, ""
    TdonnyO.Enabled =1
    PlaySound "fx_up"
    checkdonny
End Sub
...
Sub TdonnyO_hit
    TdonnyO.enabled = 0
    LdonnyO.state = 1:DMD "", "", "dmddo" , eBlink, eBlink, eNone, 2500, True, ""
    TdonnyN.Enabled =1
    PlaySound "fx_up"
    checkdonny
End Sub
...
Sub TdonnyN_hit
    TdonnyN.enabled = 0
    LdonnyN.state = 1:DMD "", "", "dmddon" , eBlink, eBlink, eNone, 2500, True, ""
    TdonnyNa.Enabled =1
    PlaySound "fx_up"
    checkdonny
End Sub
...
Sub TdonnyNa_hit
    TdonnyNa.enabled = 0
    LdonnyNa.state = 1:DMD "", "", "dmddonn" , eBlink, eBlink, eNone, 2500, True, ""
    TdonnyY.Enabled =1
    PlaySound "fx_up"
    checkdonny
End Sub
...
Sub TdonnyY_hit
    TdonnyY.enabled = 0
    LdonnyY.state = 1:DMD "", "", "dmddonny" , eBlink, eBlink, eNone, 2500, True, ""
    PlaySound "fx_up"
    checkdonny
End Sub

Sub checkdonny()
    If LdonnyD.state + LdonnyO.state + LdonnyN.state + LdonnyNa.state + LdonnyY.state = 5 Then
    AddScore 50000
    PlaySound "fx_droptarget"
    LowerRamp
    Lrampbowling.state = 2
    ...
    LdonnyY.state = 0
    Ldonny1.state = 2
    Tdonny.isdropped = 0:DMD "", "", "dmddonnyparty" , eBlink, eBlink, eNone, 3000, True, ""
    TdonnyD.enabled = 1
    End IF
End Sub
...
Sub Kbowling_hit
    ...
    Kpiste.createball: DisableFlippers False
    Wopenunder.collidable = 0
    Timerdonny.enabled=1
    Lrampbowling.state = 0
    RiseRamp
End Sub

sub Timerdonny_timer
	Timerdonny.enabled=0
    Kpiste.kick 65, 10:PlaySound "super-jackpot"
    ChangeBall(3)
    Wopenunder.collidable = 0
    AddScore 10000
...
Sub Tdonny_hit
    Tdonny.isdropped = 1 : DisableFlippers True
    AddScore 50000
    AddMultiball 2
    Ldonny.state = 1
    Ldonny1.state = 0
...
End Sub
 ...
 Sub check5bowling()
      If Ldonny.state + Ldude.state + Lwalter.state + Lmaude.state + Ljesus.state = 5 Then
      AddScore 1000000
      PlaySound ""
      checkreset
      AddMultiball 4 :DMD "", "", "dmd1million" , eBlink, eBlink, eNone, 3500, True, ""
     End IF
End sub
...
Sub checkreset()
    ...
    TdudeT.Enabled = 1
    TjesusJ.isdropped = 0
    Ldonny.state = 0:Ldude.state = 0:Lwalter.state = 0:Lmaude.state = 0:Ljesus.state = 0
    End If
    ChangeGi purple
End Sub
...
Sub couteauGTimer_Timer
    Bigquille.TransZ = couteauGPos
    icecube.TransZ = couteauGPos
...
Sub couteauDTimer_Timer
    Bigquille.TransZ = couteauDPos
    icecube.TransZ = couteauDPos
...
Sub Table1_KeyDown(ByVal Keycode)
    ...
    If bGameInPlay AND NOT Tilted Then
        ...
        If keycode = LeftFlipperKey Then SolLFlipper1 1:InstantInfoTimer.Enabled = True
        If keycode = RightFlipperKey Then SolRFlipper1 1:InstantInfoTimer.Enabled = True
...
Sub SolRFlipper(Enabled)
    If Enabled Then
        ...
        FlipperHAUT.EOSTorque = 0.65:FlipperHAUT.RotateToEnd
    Else
        ...
        FlipperHAUT.EOSTorque = 0.15:FlipperHAUT.RotateToStart
    End If
End Sub

Sub SolLFlipper1(Enabled)
    If Enabled AND bFlippersEnabled Then
        PlaySoundAt SoundFXDOF("fx_flipperup", 101, DOFOn, DOFFlippers), LeftFlipper1
        'LeftFlipper.EOSTorque = 0.65:LeftFlipper.RotateToEnd
        LeftFlipper1.EOSTorque = 0.65:LeftFlipper1.RotateToEnd
    Else
        PlaySoundAt SoundFXDOF("fx_flipperdown", 101, DOFOff, DOFFlippers), LeftFlipper1
        'LeftFlipper.EOSTorque = 0.15:LeftFlipper.RotateToStart
        LeftFlipper1.EOSTorque = 0.15:LeftFlipper1.RotateToStart
    End If
End Sub
...
Sub SolRFlipper1(Enabled)
    If Enabled AND bFlippersEnabled Then
        PlaySoundAt SoundFXDOF("fx_flipperup", 102, DOFOn, DOFFlippers), RightFlipper1
        'RightFlipper.EOSTorque = 0.65:RightFlipper.RotateToEnd
        RightFlipper1.EOSTorque = 0.65:RightFlipper1.RotateToEnd
        'FlipperHAUT.EOSTorque = 0.65:FlipperHAUT.RotateToEnd
    Else
        PlaySoundAt SoundFXDOF("fx_flipperdown", 102, DOFOff, DOFFlippers), RightFlipper1
        'RightFlipper.EOSTorque = 0.15:RightFlipper.RotateToStart
        RightFlipper1.EOSTorque = 0.15:RightFlipper1.RotateToStart
        'FlipperHAUT.EOSTorque = 0.15:FlipperHAUT.RotateToStart
    End If
...
Sub InitPolarity()
   dim x, a : a = Array(LF, RF)
    ...
    RF.SetObjects "RF", FlipperHAUT, TriggerRFhaut
End Sub
...
Sub ResetForNewGame()
    ...
    For i = 1 To MaxPlayers
        ...
        Closecar
        Ldonny.state = 0:Ldude.state = 0:Lwalter.state = 0:Lmaude.state = 0:Ljesus.state = 0
        Ldonny1.state = 0:Ldude1.state = 0:Lwalter1.state = 0:Lmaude1.state = 0:Ljesus1.state = 0
        TwalterW.Enabled = 1 : TdonnyD.Enabled = 1 : TdudeT.Enabled = 1 : TmaudeM.Enabled = 1 : TjesusJ.isdropped = 0
        'RiseRamp
        mur.collidable = 0
        Car.collidable = 0
        lcar1.state = 0:lcar2.state = 0:lcar3.state = 0:lcar4.state = 0
        Tcassecar1.isdropped =1: Tcassecar2.isdropped =1: Tcassecar3.isdropped =1: Tcassecar4.isdropped =1
        Lbowlingcar.state = 0:lgobowling.state = 0:Lightcarmode.state = 0:wallbas.visible = 1
        TbowlingB.Enabled = 1:TbowlingO.Enabled = 0:TbowlingW.Enabled = 0:TbowlinGL.Enabled = 0:TbowlingI.Enabled = 0:TbowlingN.Enabled = 0:TbowlingG.Enabled = 0
        lbowlingB.state = 0:lbowlingO.state = 0:lbowlingW.state = 0:lbowlingL.state = 0:lbowlingI.state = 0:lbowlingN.state = 0:lbowlingG.state = 0
        Tglass1.Enabled = 1:Tglass2.Enabled = 0:Tglass3.Enabled = 0:Tglass4.Enabled = 0:Tglass5.Enabled = 0:Tglass6.Enabled = 0
        Kglass1.Enabled = 0
        Walldoor.isdropped = 0
        Lglass.state = 0:Lglass1.state = 0:Lglass2.state = 0:Lglass3.state = 0:Lglass4.state = 0:Lglass5.state = 0:Lglass6.state = 0
        Lglass1a.state = 2
        Lglass2a.state = 0:Lglass3a.state = 0:Lglass4a.state = 0:Lglass5a.state = 0:Lglass6a.state = 0
    Next
...
Sub DMDScore()
    ...
    if(dqHead = dqTail)Then
        ...
        Select Case Battle(CurrentPlayer, 0)
            ...
            Case 9:tmp1 = CL("HIT RED TARGET " & 5-CaptiveBallHits)
            ...
            Case 15:tmp1 = CL("THE DUDE " & "FINAL " & Balls)
        End Select
        tmp2 = ""
    End If
...
Sub RealTime_Timer
    ...
    Car.Roty = - carR.CurrentAngle - 135
    mur.RotZ = - murR.CurrentAngle - 135
...
Sub ShowTableInfo
    ...
    DMD "", CL("A GAME OF BOWLING" &myversion), "", eNone, eNone, eNone, 2000, False, ""
...
Sub ResetNewBallVariables() 'reset variables for a new ball or player
    ...
    BumperHits = 0
    RiseRamp
    Tdude.isdropped = 1 : Tmaude.isdropped = 1 :Twalter.isdropped = 1 :Tjesus.isdropped = 1 :Tdonny.isdropped = 1
    Lrampbowling.state = 0
    ' select a battle
    SelectBattle
End Sub
...
Sub RightSlingShotHT_Slingshot
    If Tilted Then Exit Sub
    PlaySoundAt SoundFXDOF("fx_slingshot", 104, DOFPulse, DOFcontactors), Remk
    DOF 106, DOFPulse
    RightSling4HT.Visible = 1
    RemkHT.RotX = 26
    RStep = 0
    RightslingshotHT.TimerEnabled = True
    ' add some points
    AddScore 210
    ' add some effect to the table?
    ' remember last trigger hit by the ball
    LastSwitchHit = "RightslingshotHT"
    ChangeOutlanes
    ShakecouteauD
End Sub

Sub RightSlingShotHT_Timer
    Select Case RStep
        Case 1:RightSling4HT.Visible = 0:RightSling3HT.Visible = 1:RemkHT.RotX = 14
        Case 2:RightSling3HT.Visible = 0:RightSling2HT.Visible = 1:RemkHT.RotX = 2
        Case 3:RightSling2HT.Visible = 0:RemkHT.RotX = -10:RightslingshotHT.TimerEnabled = 0
    End Select
    RStep = RStep + 1
End Sub
...
Sub Cup1Timer_Timer
    ...
    cup1.TransY = Cup1Pos
    Bigquille.TransY = Cup1Pos
    icecube.TransY = Cup1Pos
...
Sub Cup2Timer_Timer
    Cup2.TransY = Cup2Pos
    Bigquille.TransY = Cup2Pos
    icecube.TransY = Cup2Pos
...
Sub Check3BankTargets
     If light12.state + light13.state + light14.state = 3 Then
        ...
        light13.state = 0
        light14.state = 0
        Targetsave.isdropped = 0: PlaySoundAt "Fx_rebond", Targetsave
        Lightsave1.state = 2
        Addscore 50000 
        LightEffect 1
        FlashEffect 2
...
Sub Targetsave_hit
    PlaySound "fx_phone_ring"
    Targetsave.isdropped = 1
    Lightsave.state = 1
    Lightsave1.state = 0
...
Sub Check5BankTargets
    ...
    If light15.state + light16.state + Light16a.state + light17.state + light18.state + light19.state = 6 Then
        ...
        DMD "COLLECTED ALL ", "THE OBJECTS", "monster_" &tmp, eNone, eNone, eNone, 2500, True, "splendid1"
        LightEffect 1
        FlashEffect 1
...
Sub PyramidExit()
    ...
    DOF 121, DOFPulse
    PyramidKicker.kick 160, 5
    PlaySoundAt "fx_doubledoing", PyramidKicker
End Sub
...
Sub GiveRandomAward() 'from the Pyramid
    ...
    Select Case tmp
        Case 1, 2, 3, 4, 5, 6 'Lit Extra Ball
            DMD "", CL("EXTRA BALL IS LIT"), "", eNone, eBlink, eNone, 1500, True, "fx_fanfare8"
            light23.State = 2
        Case 7, 8, 13, 14, 15 '100,000 points
            DMD CL("BIG POINTS"), CL("100000"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare8"
            AddScore 100000
        Case 9, 10, 11, 12 'Hold Bonus
            DMD CL("BONUS HELD"), CL("ACTIVATED"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare8"
            bBonusHeld = True
        Case 16, 17, 18 'Increase Bonus Multiplier
            DMD CL("INCREASED"), CL("BONUS X"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare8"
            AddBonusMultiplier 1
        ...
        Case 22, 23, 36, 37, 38 'PlayField multiplier
            DMD CL("INCREASED"), CL("PLAYFIELD X"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare8"
            AddPlayfieldMultiplier 1
        ...
        Case 29, 30, 31, 32, 33, 34, 35 'Increase Bumper value
            BumperValue(CurrentPlayer) = BumperValue(CurrentPlayer) + 500
            DMD CL("BUMPER VALUE"), CL(BumperValue(CurrentPlayer)), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare8"
        Case 39, 40, 43, 44 'extra multiball
            DMD CL("EXTRA"), CL("MULTIBALL"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare8"
            AddMultiball 1
        Case 45, 46, 47, 48 ' Ball Save
            DMD CL("BALL SAVE"), CL("ACTIVATED"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare8"
            EnableBallSaver 20
        Case ELSE 'Add a Random score from 10.000 to 100,000 points
            tmp2 = INT((RND) * 9) * 10000 + 10000
            DMD CL("EXTRA POINTS"), CL(tmp2), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare8"
            AddScore tmp2
    End Select
End Sub
...
Sub RightRampDone_Hit
    ...
    If light31.State = 2 Then
        DMD CL("WALTER GUN"), CL(jackpot(CurrentPlayer)), "_", eNone, eBlinkFast, eNone, 1000, True, "vo_Jackpot"
        AddScore Jackpot(CurrentPlayer)
        LightEffect 2
        FlashEffect 2
    Else
...
Sub StartBattle
    ...
    Select Case NewBattle
        Case 1 'DONNY = Super Spinners
            DMD CL("DONNY"), CL("DONNY SPINNERS"), "", eNone, eNone, eNone, 1500, True, ""
            Light45.State = 2
            Light49.State = 2
            SpinCount = 0
        Case 2 'Calakmul = Super Pop Bumpers
            DMD CL("JACKPOT"), CL("EXPLODES THE BUMPERS"), "", eNone, eNone, eNone, 1500, True, ""
            Light22.State = 2
            LightSeqBumpers.Play SeqRandom, 10, , 1000
            SuperBumperHits = 0
        Case 3 'Sierra de Chiapas = Ramps
            DMD CL("MARK IT"), CL("AIMS AT RAMPS"), "", eNone, eNone, eNone, 1500, True, ""
            Light47.State = 2
            Light48.State = 2
            RampHits3 = 0
        Case 4 'REAL = Orbits
            DMD CL("A REAL CHARACTER"), CL("SHOOT THE ORBITS"), "", eNone, eNone, eNone, 1500, True, ""
            Light45.State = 2
            Light49.State = 2
            OrbitHits = 0
        Case 5 'WALTER = Shoot the lights 2
            DMD CL("WALTER"), CL("SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            Light44.State = 2
            Light45.State = 2
            Light46.State = 2
            Light47.State = 2
            ...
            Light49.State = 2
            Light50.State = 2
        Case 6 'RANSON = Shoot the lights 1
            DMD CL("RANSOM NOTE"), CL("SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            Light44.State = 2
        Case 7 'MAUDE =  Target Frenzy
            DMD CL("MAUDE"), CL("TARGETS-RAMPS"), "", eNone, eNone, eNone, 1500, True, ""
            LightSeqAllTargets.Play SeqRandom, 10, , 1000
            TargetHits7 = 0
        Case 8 'MONEY = Left & Right Targets
            DMD CL("WHERE IS THE MONEY"), CL("LANES"), "", eNone, eNone, eNone, 1500, True, ""
            Light44.State = 2
            Light12.State = 2
            Light13.State = 2
            Light14.State = 2
            Light50.State = 2
            TargetHits8 = 0
        Case 9 'FEMALE = Captive Ball
            DMD CL("FEMALE FORM"), CL("SHOOT RED TARGET"), "", eNone, eNone, eNone, 1500, True, ""
            Light29.State = 2
            CaptiveBallHits = 0
        Case 10 'JESUS= Ramps and Orbits
            'uses the ramphits10 to count the hits
            DMD CL("JESUS"), CL("SHOOT RAMPS AND LANE"), "", eNone, eNone, eNone, 1500, True, ""
            Light47.State = 2
            Light48.State = 2
            RampHits10 = 0
        Case 11 'BLUE = Blue Targets
            DMD CL("COLLECT BALL"), CL("SHOOT BLUE TARGETS"), "", eNone, eNone, eNone, 1500, True, ""
            LightSeqBlueTargets.Play SeqRandom, 10, , 1000
            TargetHits11 = 0
        Case 12 'CARPET = Super Loops
            DMD CL("RUG MODE"), CL("CARPET WASH"), "", eNone, eNone, eNone, 1500, True, ""
            Light45.State = 2
            Light49.State = 2
            Gate2.Open = 1
            Gate3.Open = 1
            ...
            StartSpots
            loopCount = 0
        Case 13 'LIGHT = Follow the Lights 1
            DMD CL("RINGER DROP OFF"), CL("SHOOT LIT LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            FollowTheLights.Enabled = 1
            AddMultiball 2
            StartJackpots
            ChangeGi green
        Case 14 'LIGHT = Follow the Lights 2
            DMD CL("EXPLOSIVE"), CL("SHOOT LIT LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            FollowTheLights.Enabled = 1
            AddMultiball 2
            StartJackpots
            ChangeGi yellow
        Case 15 'BASH - the final battle
            DMD CL("BASH THE CAR"), CL("SHOOT THE JACKPOTS"), "", eNone, eNone, eNone, 1500, True, ""
            AddMultiball 3
            StartJackpots
            ChangeGi red
    End Select
...
Sub StopBattle2
    ...
    Select Case NewBattle
        ...
        Case 12:Gate2.Open = 0:Gate3.Open = 0:StopSpots 
