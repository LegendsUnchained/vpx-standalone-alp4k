' Taito's Polar Explorer / IPD No. 4588 / 4 Players / 1983
...
Dim bsTrough, dtbankL, dtbankR, dtbankT, bsSaucer, TopFlipperActive, x

Const cGameName = "polar"
...
End Sub
 ...
 Sub Gate5_Animate:WireRamp.rotx = 20 - Gate5.Currentangle / 4.5:End Sub
...
NVramPatchLoad
    ...
    With Controller
        ...
        .SplashInfoLine = "Polar Explorer - Taito 1983" & vbNewLine & "VPX table by JPSalas v5.5.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
    ...
    bsSaucer.InitSaucer sw2, 2, 0, 28
    ...
    dtbankR.InitDrop Array(sw12, sw22, sw32), Array(12, 22, 32)
    dtbankR.InitSnd SoundFX("fx_droptarget", DOFDropTargets), SoundFX("fx_resetdrop", DOFContactors)
    dtbankR.CreateEvents "dtbankR"

    Set dtbankL = New cvpmDropTarget
    dtbankL.InitDrop Array(sw11, sw21, sw31, sw41), Array(11, 21, 31, 41)
    ...
    dtbankT.InitDrop Array(sw4, sw14, sw24, sw34, sw44), Array(4, 14, 24, 34, 44)
...
' Workaround to activate the flippers when coming down from the upper playfield

Sub Gate5_Hit: vpmTimer.PulseSw 51: End Sub
...
Sub Bumper2_Hit:vpmTimer.PulseSw 64:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper2:End Sub

' Drain & Saucers
Sub Drain_Hit:PlaysoundAt "fx_drain", Drain:bsTrough.AddBall Me:End Sub
Sub sw2_Hit:PlaysoundAt "fx_kicker_enter", sw2:bsSaucer.AddBall 0:End Sub

' Rollovers
Sub sw3_Hit:Controller.Switch(3) = 1:PlaySoundAt "fx_sensor", sw3:lisw3.Duration 1, 600, 0:End Sub
...
Sub sw33_Hit:Controller.Switch(33) = 1:PlaySoundAt "fx_sensor", sw33:lisw33.Duration 1, 600, 0:End Sub
Sub sw33_UnHit:Controller.Switch(33) = 0:End Sub

Sub sw43_Hit:Controller.Switch(43) = 1:PlaySoundAt "fx_sensor", sw43:lisw43.Duration 1, 600, 0:End Sub
...
' Spinners
Sub sw74_Spin:vpmTimer.PulseSw 74:PlaySound "fx_spinner", 0, 1, 0.05:End Sub
...
' UpperPlayfield flippers
Sub sw53_Hit:Controller.Switch(53) = 1:TopFlipperActive = True:End Sub
...
SolCallback(5) = "SolEMKicker"
SolCallback(6) = "SolUpperPF"
...
Sub sw2_Timer
    Select Case EMKStep
        Case 1:sw2EMK.RotX = 14
        Case 2:sw2EMK.RotX = 2
        Case 3:sw2EMK.RotX = -10:sw2.TimerEnabled = 0
    End Select
    EMKStep = EMKStep + 1
End Sub

Sub SolUpperPF(Enabled)
    TopFlipperActive = Enabled 'enable top flippers or lower flippers
    If Enabled Then 'turn off lower flippers
        LeftFlipper.RotateToStart
        RightFlipper.RotateToStart
    Else ' turn off top flippers
...
Sub LeftFlipper1_Animate:LeftFlipper1Top.RotZ = LeftFlipper1.CurrentAngle: End Sub
Sub RightFlipper1_Animate: RightFlipper1Top.RotZ = RightFlipper1.CurrentAngle: End Sub
