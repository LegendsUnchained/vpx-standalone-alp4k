...
Const BGAnimate = 1 'Animate Dark's Bicyle Girl when lift ramp is up.
...
Const AccurateBG = 0 'Use an accurate model of Bicycle Girl (No animation)
...
Sub Table_KeyDown(ByVal Keycode)
 ...
 ' 	If keycode = LeftTiltKey Then nudgebobble(keycode):End If
	If keycode = LeftTiltKey Then Nudge 90, 4:nudgebobble(keycode):End If
'    If keycode = RightTiltKey Then nudgebobble(keycode):End If
	If keycode = RightTiltKey Then Nudge 270, 4:nudgebobble(keycode):End If
    If Keycode = StartGameKey Then Controller.Switch(16) = 1
    If keycode = CenterTiltKey Then Nudge 0, 4:End If
...
Sub Sol20(Enabled)
F20a.Intensity = Enabled 
F20b.Intensity = Enabled *2
End Sub
...
End Sub
	...
	if Zeit >= 10 then AP = False : 	PlaySound "Plunger"
End Sub
...
Sub WZ_Hit:Controller.Switch(2) = 0:WZOpen = True: Playsound "PlastikHit":End Sub
...
Ball.visible = 0
Ball.Transz = -405
playsound SoundFX("Crossbowschuss",DOFContactors)
End If
End Sub
...
Playsound SoundFX("PlastikHit",DOFShaker)
me.timerenabled = 1
End Sub
...
me.enabled = 0
End If
RotXfrom74to90.RotX = RotXfrom74to90.RotX + 0.5
Case 2:
...
IF Primitive271.RotY < PWdir Then
Primitive271.RotY = Primitive271.RotY + (PWspeed) 
END If
...
IF Primitive271.Rotx < PWdirb Then
Primitive271.Rotx = Primitive271.Rotx + (PWspeed/2)
END If
...
Dim bgdegree:bgdegree = 8 'move +/- 8 degrees
Dim bgdurationctr:bgdurationctr = 2
Dim bgcharctr2:bgcharctr2 = 2
Dim centerlocation2:centerlocation2 = 2
Dim bgdegree2:bgdegree2 = 8 'move +/- 8 degrees
Dim bgdurationctr2:bgdurationctr2 = 2
...
Sub Nudgebobble(keycode)
	If keycode = LeftTiltKey then bgcharctr = -4:bgcharctr2 = -4  'if nudge left, move in - direction
	If keycode = RightTiltKey then bgcharctr = 4:bgcharctr2 = 4  'if nudge left, move in + direction
	If keycode = CenterTiltKey then 		'if nudge center, generate random number 1 or 2.  If 1 change it to -2.  use this number for initial direction
		Dim randombobble:randombobble = Int(2 * Rnd + 8)
...
Sub sw3_Hit()
vpmTimer.PulseSw 3
playsound SoundFX("PlastikHit",DOFTargets)
Primitive271.TransY = Primitive271.TransY + 5
Primitive271.ObjRotX = 8
me.timerenabled = 1
End Sub

Sub sw3_timer()
Primitive271.TransY = Primitive271.TransY - 5
Primitive271.ObjRotX = 0
sw3.timerenabled = 0
End Sub
...
Sub sw4_Hit  : playsound SoundFX("PlastikHit",DOFShaker): End Sub ' prison door closed
...
l33a.ColorFull = RGB(Lampstate(195),Lampstate(196),Lampstate(197))
l57.ColorFull = RGB(Lampstate(187),Lampstate(188),Lampstate(189))
l57a.ColorFull = RGB(Lampstate(187),Lampstate(188),Lampstate(189))
l36.ColorFull = RGB(Lampstate(203),Lampstate(204),Lampstate(205))
l36a.ColorFull = RGB(Lampstate(203),Lampstate(204),Lampstate(205))
l24.ColorFull = RGB(Lampstate(168),Lampstate(169),Lampstate(170))
l24a.ColorFull = RGB(Lampstate(168),Lampstate(169),Lampstate(170))
l41.ColorFull = RGB(Lampstate(152),Lampstate(153),Lampstate(154))
l41a.ColorFull = RGB(Lampstate(152),Lampstate(153),Lampstate(154))
l80.ColorFull = RGB(Lampstate(133),Lampstate(134),Lampstate(135))
l80a.ColorFull = RGB(Lampstate(133),Lampstate(134),Lampstate(135))
'l80.ColorFull = RGB(Lampstate(139),Lampstate(140),Lampstate(141))
'l80a.ColorFull = RGB(Lampstate(139),Lampstate(140),Lampstate(141))
l79.ColorFull = RGB(Lampstate(136),Lampstate(137),Lampstate(138))
l79a.ColorFull = RGB(Lampstate(136),Lampstate(137),Lampstate(138))
