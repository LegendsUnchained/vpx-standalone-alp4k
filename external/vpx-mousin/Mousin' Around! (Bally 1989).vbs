...
' Release notes:
'
' Version 1.1: Herweh's mouse hole multiball
'			   Some minor VP, graphical and coding bugfixes, like
...
'			   - and a bit more which a can't remember :-)
'
...
Dim GIColorMod, FlipperColorMod, LetTheBallJump, ActivateMouseHoleMultiball, EnableGI, EnableFlasher, ShowBallShadow, ShadowOpacityGIOff, ShadowOpacityGIOn, RailsVisible
...
If Version < 10500 Then
	MsgBox "This table requires Visual Pinball 10.5 or newer!" & vbNewLine & "Your version: " & Replace(Version/1000,",","."), , "Mousin' Around VPX"
End If
...
Sub MouseHoleWaitTimer_Timer()
	...
	ElseIf MouseHoleWaitTimer.Interval = 1000 Then
		...
		Case 2
			SetLEDs "   HA HA HAA..  " & "   GOTCHA       ", 1
			StartMouseHoleFlasher
		Case 4
			SetLEDs "   MOUSE HOLE   " & " BALL " & lockedMouseHoleBalls & " LOCKED  ", 2
		Case 5
			StopMouseHoleFlasher
		Case 6
			SetLEDs "   MOUSE HOLE   " & " BALL " & lockedMouseHoleBalls & " LOCKED  ", 1
			SolGI False
	...
	ElseIf MouseHoleWaitTimer.Interval = 1001 Then
		...
		Case 1
			If DesktopMode Then noStandardDisplay = True
			SetLEDs "   MOUSE HOLE   " & "  TRAP IS OPEN  ", 3
		Case 3
			MouseHoleWaitTimer.Enabled = False
			ClearAllLEDs : If DesktopMode Then noStandardDisplay = False
			MouseHoleWaitStep = 0
...
' ****************************************************
' stand-up targets
Sub sw17_Hit()   : StandUpTarget 17, sw17, pTarget17, pTargetPost17, True  : Check4Multiball : End Sub
Sub sw17_Timer() : StandUpTarget 17, sw17, pTarget17, pTargetPost17, False : End Sub
Sub sw18_Hit()   : StandUpTarget 18, sw18, pTarget18, pTargetPost18, True  : Check4Multiball : End Sub
Sub sw18_Timer() : StandUpTarget 18, sw18, pTarget18, pTargetPost18, False : End Sub
Sub sw19_Hit()   : StandUpTarget 19, sw19, pTarget19, pTargetPost19, True  : Check4Multiball : End Sub
Sub sw19_Timer() : StandUpTarget 19, sw19, pTarget19, pTargetPost19, False : End Sub
Sub sw20_Hit()   : StandUpTarget 20, sw20, pTarget20, pTargetPost20, True  : Check4Multiball : End Sub
Sub sw20_Timer() : StandUpTarget 20, sw20, pTarget20, pTargetPost20, False : End Sub
Sub sw21_Hit()   : StandUpTarget 21, sw21, pTarget21, pTargetPost21, True  : Check4Multiball : End Sub
Sub sw21_Timer() : StandUpTarget 21, sw21, pTarget21, pTargetPost21, False : End Sub
Sub sw25_Hit()   : StandUpTarget 25, sw25, pTarget25, pTargetPost25, True  : Check4Multiball : End Sub
Sub sw25_Timer() : StandUpTarget 25, sw25, pTarget25, pTargetPost25, False : End Sub
Sub sw26_Hit()   : StandUpTarget 26, sw26, pTarget26, pTargetPost26, True  : Check4Multiball : End Sub
Sub sw26_Timer() : StandUpTarget 26, sw26, pTarget26, pTargetPost26, False : End Sub
Sub sw27_Hit()   : StandUpTarget 27, sw27, pTarget27, pTargetPost27, True  : Check4Multiball : End Sub
Sub sw27_Timer() : StandUpTarget 27, sw27, pTarget27, pTargetPost27, False : End Sub
Sub sw28_Hit()   : StandUpTarget 28, sw28, pTarget28, pTargetPost28, True  : Check4Multiball : End Sub
Sub sw28_Timer() : StandUpTarget 28, sw28, pTarget28, pTargetPost28, False : End Sub
Sub sw36_Hit()   : StandUpTarget 36, sw36, pTarget36, pTargetPost36, True  : End Sub
Sub sw36_Timer() : StandUpTarget 36, sw36, pTarget36, pTargetPost36, False : End Sub

' standup-targets in front of the motor bank
Sub sw29_Hit()   : StandUpTarget 29, sw29, pTarget29, pTargetPost29, True  : End Sub
Sub sw29_Timer() : StandUpTarget 29, sw29, pTarget29, pTargetPost29, False : End Sub
Sub sw30_Hit()   : StandUpTarget 30, sw30, pTarget30, pTargetPost30, True  : End Sub
Sub sw30_Timer() : StandUpTarget 30, sw30, pTarget30, pTargetPost30, False : End Sub
Sub sw31_Hit()   : StandUpTarget 31, sw31, pTarget31, pTargetPost31, True  : End Sub
Sub sw31_Timer() : StandUpTarget 31, sw31, pTarget31, pTargetPost31, False : End Sub

' top lanes
Sub sw22_Hit()   : Controller.Switch(22) = True  : RollOverSound : End Sub
Sub sw22_Unhit() : Controller.Switch(22) = False : SolOrbitGate True : End Sub
Sub sw23_Hit()   : Controller.Switch(23) = True  : RollOverSound : End Sub
Sub sw23_Unhit() : Controller.Switch(23) = False : SolOrbitGate True : End Sub
Sub sw24_Hit()   : Controller.Switch(24) = True  : RollOverSound : End Sub
Sub sw24_Unhit() : Controller.Switch(24) = False : SolOrbitGate True : End Sub

' orbit lanes
Sub sw15_Hit()   : Controller.Switch(15) = True  : RollOverSound : End Sub
Sub sw15_Unhit() : Controller.Switch(15) = False : End Sub
Sub sw16_Hit()   : Controller.Switch(16) = True  : RollOverSound : End Sub
Sub sw16_Unhit() : Controller.Switch(16) = False : End Sub

' inlanes and outlanes
Sub sw38_Hit() :   Controller.Switch(38) = True  : RollOverSound : Check4Multiball : End Sub
Sub sw38_Unhit() : Controller.Switch(38) = False : End Sub
Sub sw39_Hit() :   Controller.Switch(39) = True  : RollOverSound : Check4Multiball : End Sub
Sub sw39_Unhit() : Controller.Switch(39) = False : End Sub
Sub sw40_Hit() :   Controller.Switch(40) = True  : RollOverSound : End Sub
...
' plunger switch
Sub sw14_Hit()   : Controller.Switch(14) = True  : RollOverSound : Check4MultiballSW14 : End Sub   
