...
' VPX8 - version by JPSalas 2018, version 5.5.0
...
Sub flippergate_Animate: OrbitGate.Rotz = flippergate.Currentangle: End Sub
...
NVramPatchLoad
    ...
    With Controller
        ...
        .SplashInfoLine = "Fire Action De Luxe- Taito 1983" & vbNewLine & "VPX table by JPSalas v.5.5.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub table1_KeyDown(ByVal Keycode)
    ...
    If keycode = PlungerKey Then PlaySoundAt "fx_kicker", sw21:Controller.Switch(65) = 1
End Sub
...
Sub Bumper2_Hit:vpmTimer.PulseSw 5:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper2:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 25:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper3:End Sub
Sub Bumper4_Hit:vpmTimer.PulseSw 35:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper4:End Sub
...
' Spinners
Sub sw24_Spin:vpmTimer.PulseSw 24:PlaySoundAt "fx_spinner", sw24:End Sub
