# JP's Pokémon Pinball (JP Salas)

![Table Preview](../../images/vpx-jp-pokemon-preview.png)
...
- Add your personalized launcher.elf and rename it to `vpx-jp-pokemon.elf`
- Download the table and directb2s versions listed above, extract (if necessary) and copy them into `vpx-jp-pokemon`
