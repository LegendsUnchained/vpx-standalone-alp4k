' ****************************************************************
'       John WICK By BALUTITO
'    Based on   "IT"  Table built by jpsalas
...
Const Ball = 1 		' Golden Ball = 0 Chrome Ball = 1

' Sound and music volumes
Const SongVolume = 0.5 ' 1 is full volume, but I set it quite low to listen better the other sounds since I use headphones, adjust to your setup :)
...
Const cGameName = "johnwick" 'used for DOF
Const myVersion = "1.0  "
...
Sub Table1_KeyDown(ByVal Keycode)
    ...
    If bGameInPlay AND NOT Tilted Then
        ...
        If keycode = RightFlipperKey Then SolRFlipper 1:InstantInfoTimer.Enabled = True:RotateLaneLights 0' : StartGun
...
Sub SolRFlipper(Enabled)
    If Enabled Then
        ...
        RightFlipper001.EOSTorque = 0.65:RightFlipper001.RotateToEnd
    Else
        PlaySoundAt SoundFXDOF("fx_flipperdown", 102, DOFOff, DOFFlippers), RightFlipper
        RightFlipper.EOSTorque = 0.15:RightFlipper.RotateToStart
        RightFlipper001.EOSTorque = 0.15:RightFlipper001.RotateToStart
    End If
End Sub
...
Sub ResetForNewGame()
    ...
    Game_Init()
    UpdateBallInPlay : pupevent 950

    ' you may wish to start some music, play a sound, do whatever at this point
    PlaySound "vo_start" &RndNbr(3) : pupevent 903
...
Sub EndOfBall()
    ...
    If NOT Tilted Then
        ...
        DMD CL("   ENEMIES-ALLIES " & ModesWon(CurrentPlayer)), CL(FormatScore(AwardPoints)), "", eNone, eNone, eNone, 800, True, ""
        LightEffect 4

        'Balloons popped X 100.000
        AwardPoints = Balloons(CurrentPlayer) * 100000
        TotalBonus = TotalBonus + AwardPoints
        DMD CL("    COINS EARNED " & Balloons(CurrentPlayer)), CL(FormatScore(AwardPoints)), "", eNone, eNone, eNone, 800, True, ""
        ...
        If TotalBonus > 750000 Then
            DMD CL("   TOTAL BONUS MULT "), CL(FormatScore(TotalBonus * BonusMultiplier(CurrentPlayer))), "", eNone, eNone, eNone, 2000, True, "vo_greatbonus" &RndNbr(3)
        Else 
            DMD CL("    TOTAL BONUS "), CL(FormatScore(TotalBonus * BonusMultiplier(CurrentPlayer))), "", eNone, eNone, eNone, 2000, True, "vo_bonus" &RndNbr(2)
        End If
...
Sub EndOfBall2()
    ...
    If ExtraBallsAwards(CurrentPlayer) > 0 Then
        ...
        DMD CL("    EXTRA BALL"), CL("    FIRE AGAIN"), "", eNone, eBlink, eNone, 1500, True, "vo_extraball" &RndNbr(2)
...
Sub EndOfBallComplete()
    ...
    If((BallsRemaining(CurrentPlayer) <= 0)AND(BallsRemaining(NextPlayer) <= 0))Then
		...
		CabGlassStart
		FaroisFlash.ImageA = "FaroisTransparent"
    ...
    Else
        ...
        If PlayersPlayingGame > 1 Then
            Select Case CurrentPlayer
                Case 1:DMD "", CL("    PLAYER 1"), "", eNone, eNone, eNone, 1000, True, "vo_player1" : pupevent 905
                Case 2:DMD "", CL("    PLAYER 2"), "", eNone, eNone, eNone, 1000, True, "vo_player2" : pupevent 906
                Case 3:DMD "", CL("    PLAYER 3"), "", eNone, eNone, eNone, 1000, True, "vo_player3" : pupevent 907
                Case 4:DMD "", CL("    PLAYER 4"), "", eNone, eNone, eNone, 1000, True, "vo_player4" : pupevent 908
            End Select
        Else
            DMD "", CL("    PLAYER 1"), "", eNone, eNone, eNone, 1000, True, "vo_youareup" : pupevent 905
        End If
    End If
End Sub
...
Sub ExtraBallIsLit
    DMD "_", CL("   EXTRA BALL LIT"), "", eNone, eNone, eNone, 1500, True, "vo_extraballislit"
    li044.State = 1
	PuPEvent 915
End Sub
...
Sub AwardSkillshot(points)
    ...
    'show dmd animation
    DMD CL("    SKILLSHOT"), CL(FormatScore(points)), "d_border", eNone, eBlinkFast, eNone, 2000, True, "vo_skillshot" : 	PuPEvent 920
    DOF 127, DOFPulse
    AddScore points
    'do some light show
    GiEffect 3
...
Sub AwardSuperSkillshot(points)
    ResetSkillShotTimer_Timer
    'show dmd animation
    DMD CL("    SUPER SKILLSHOT"), CL(FormatScore(points)), "d_border", eNone, eBlinkFast, eNone, 2000, True, "vo_superskillshot" : 	PuPEvent 921
    DOF 127, DOFPulse
    AddScore points
    'do some light show
    GiEffect 3
...
Sub AwardCombo
    ...
    Select Case ComboCount
        Case 1:DMD CL("    COMBO"), CL(FormatScore(ComboValue(CurrentPlayer))), "", eNone, eNone, eNone, 1500, True, "vo_combo1":ComboHits(CurrentPlayer) = ComboHits(CurrentPlayer) + 1: PuPEvent 922
        Case 2:DMD CL("  2X COMBO"), CL(FormatScore(ComboValue(CurrentPlayer) * 2)), "", eNone, eNone, eNone, 1500, True, "vo_combo2":ComboHits(CurrentPlayer) = ComboHits(CurrentPlayer) + 1: PuPEvent 923
        Case 3:DMD CL("  3X COMBO"), CL(FormatScore(ComboValue(CurrentPlayer) * 3)), "", eNone, eNone, eNone, 1500, True, "vo_combo3":ComboHits(CurrentPlayer) = ComboHits(CurrentPlayer) + 1: PuPEvent 924
        Case 4:DMD CL("  4X COMBO"), CL(FormatScore(ComboValue(CurrentPlayer) * 4)), "", eNone, eNone, eNone, 1500, True, "vo_combo4":ComboHits(CurrentPlayer) = ComboHits(CurrentPlayer) + 1: PuPEvent 925
        Case 5:DMD CL("  5X COMBO"), CL(FormatScore(ComboValue(CurrentPlayer) * 5)), "", eNone, eNone, eNone, 1500, True, "vo_combo5":ComboHits(CurrentPlayer) = ComboHits(CurrentPlayer) + 1: PuPEvent 926
        Case Else:DMD CL("  SUPER COMBO"), CL(FormatScore(ComboValue(CurrentPlayer) * 10)), "", eNone, eNone, eNone, 1500, True, "vo_supercombo":ComboHits(CurrentPlayer) = ComboHits(CurrentPlayer) + 1: PuPEvent 927
    End Select
...
Sub LoadLUT
    bLutActive = False
    x = LoadValue(MyTable, "LUTImage")
    If(x <> "")Then LUTImage = x Else LUTImage = 0
    UpdateLUT
End Sub

Sub SaveLUT
    SaveValue MyTable, "LUTImage", LUTImage
End Sub
    ...
    If UseFlexDMD Then
        ...
        If Not FlexDMD is Nothing Then
            If FlexDMDHighQuality Then
                ...
                For i = 0 to 19 ' Top
                    DMDScene.GetImage("Dig" & i).SetBounds 4 + (i - 2) * 13.33, 10, 16.66, 16.66
                Next
                For i = 20 to 39 ' Bottom
                    DMDScene.GetImage("Dig" & i).SetBounds 4 + (i - 22) * 13.33, 36.66, 16.66, 16.66
                Next
            ...
            Else
                ...
                digitgrid.Visible = False
                For i = 0 to 19 ' Top
                    DMDScene.GetImage("Dig" & i).SetBounds 4 + (i - 2) * 40, 30, 50, 50
                Next
                For i = 20 to 39 ' Bottom
                    DMDScene.GetImage("Dig" & i).SetBounds 4 + (i - 22) * 40, 110, 50, 50
                Next
                FlexDMD.LockRenderThread
                FlexDMD.Stage.AddActor DMDScene
                FlexDMD.UnlockRenderThread
...
Sub DMDScore()
    ...
    if(dqHead = dqTail)Then
        ...
        Select Case Mode(CurrentPlayer, 0)
            ...
            Case 3
                tmp = FL("   PLAYER " &CurrentPlayer, FormatScore(Score(Currentplayer)))
                tmp1 = CL("  RAMP HITS LEFT " & RampsToHit3-RampHits3)
            Case 4
                tmp = FL("   PLAYER " &CurrentPlayer, FormatScore(Score(Currentplayer)))
            ...
            Case 7
                tmp = FL("   PLAYER " &CurrentPlayer, FormatScore(Score(Currentplayer)))
                tmp1 = CL("   MARKS LEFT " & TargetsToHit7-TargetHits7)
            Case 8
                tmp = FL("   PLAYER " &CurrentPlayer, FormatScore(Score(Currentplayer)))
                tmp1 = CL("  FIRE RED MARKS")
            Case 9
                tmp = FL("   PLAYER " &CurrentPlayer, FormatScore(Score(Currentplayer)))
                tmp1 = CL("  FIRE GREEN MARKS")
            Case 10
                tmp = FL("   PLAYER " &CurrentPlayer, FormatScore(Score(Currentplayer)))
                tmp1 = CL("   FIRE BLUE MARKS")
            Case 11
                tmp = FL("   PLAYER " &CurrentPlayer, FormatScore(Score(Currentplayer)))
...
Sub ShowTableInfo
    ...
    Else
        ...
        End If
    End If
    DMD "        BALUTITO", "           AND", "d_jppresents", eNone, eNone, eNone, 3000, False, ""
    DMD "   TEAMTUGA", "    PRESENTS...", "d_joe", eNone, eNone, eNone, 3000, False, ""
...
Sub InstantInfo
    ...
    Select Case Mode(CurrentPlayer, 0)
        Case 1
            DMD CL("   DEFEAT IOSEF"), CL("  FIRE THE SPINNER"), "", eNone, eNone, eNone, 1500, True, ""
        Case 2
            DMD CL("   DEFEAT VIGGO"), CL("   HIT POP BUMPERS"), "", eNone, eNone, eNone, 1500, True, ""
        Case 3
            DMD CL("  DEFEAT CASSIAN"), CL("  FIRE THE RAMPS"), "", eNone, eNone, eNone, 1500, True, ""
        Case 4
            DMD CL("   DEFEAT ARES"), CL("   FIRE THE ORBIT"), "", eNone, eNone, eNone, 1500, True, ""
        Case 5
            DMD CL("  DEFEAT SANTINO"), CL("   FIRE THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
        Case 6
            DMD CL("   DEFEAT ZERO"), CL("   FIRE THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
        Case 7
            DMD CL("  DEFEAT KILLA"), CL("  FIRE THE MARKS"), "", eNone, eNone, eNone, 1500, True, ""
        Case 8
            DMD CL("  KOJI HELPS"), CL("    FIRE RED MARKS"), "", eNone, eBlink, eNone, 1500, True, ""
        Case 9
            DMD CL("  KANE HELPS"), CL("  FIRE GREEN MARKS"), "", eNone, eBlink, eNone, 1500, True, ""
        Case 10
            DMD CL("  MR NOBODY HELPS"), CL("  FIRE BLUE MARKS"), "", eNone, eBlink, eNone, 1500, True, ""
        Case 11
            DMD CL("  SOFIA HELPS"), CL("  HIT A COMBO"), "", eNone, eNone, eNone, 1500, True, ""
        Case 12
            DMD CL(" HITMAN MODE"), CL("  FIRE JACKPOTS"), "", eNone, eNone, eNone, 2000, True, ""
        Case 13 
            DMD CL(" ASSASSIN MODE"), CL("  FIRE JACKPOTS"), "", eNone, eNone, eNone, 2000, True, ""
        Case 14
            DMD CL(" BOGGEYMAN MODE"), CL(" SHOOT JOHN WICK"), "", eNone, eNone, eNone, 2000, True, ""
    End Select
    DMD CL("    YOUR SCORE "), CL(FormatScore(Score(CurrentPlayer))), "", eNone, eNone, eNone, 2000, False, ""
    DMD CL("    PLAYFIELD MULTI "), CL("    X " &PlayfieldMultiplier(CurrentPlayer)), "", eNone, eNone, eNone, 2000, False, ""
    DMD CL("    BONUS MULTI "), CL("    X " &BonusMultiplier(CurrentPlayer)), "", eNone, eNone, eNone, 2000, False, ""
    DMD CL("    JACKPOT VALUE "), CL(FormatScore(Jackpot(CurrentPlayer))), "", eNone, eNone, eNone, 2000, False, ""
    DMD CL("   SP JACKPOT VALUE "), CL(FormatScore(SuperJackpot(CurrentPlayer))), "", eNone, eNone, eNone, 2000, False, ""
    If Score(1)Then
...
Sub LeftSlingShot_Slingshot
    If Tilted Then Exit Sub
    PlaySoundAt SoundFXDOF("fx_slingshot", 106, DOFPulse, DOFcontactors), Lemk
...
Sub RightSlingShot_Slingshot
    If Tilted Then Exit Sub
    PlaySoundAt SoundFXDOF("fx_slingshot", 107, DOFPulse, DOFcontactors), Remk
...
Sub LeftSlingShot001_Slingshot
    If Tilted Then Exit Sub
    PlaySoundAt SoundFXDOF("fx_slingshot", 108, DOFPulse, DOFcontactors), Lemk001
...
Sub Trigger013_Hit
    ...
    If bAddABallReady AND bMultiBallMode Then 'award add-a-ball but only if during multiball
        DMD "_", CL("   ADD A FREE BALL"), "", eNone, eBlink, eNone, 1500, True, "" : pupevent 852
        bAddABallReady = False
        li059.State = 0
        LightEffect 1
        AddMultiball 1
    ...
    If AddABallHits(CurrentPlayer) = 0 Then 'enable add-a-ball light
        DMD "_", CL("  FREE BALL IS LIT"), "", eNone, eBlink, eNone, 1500, True, "": pupevent 853
        bAddABallReady = True
        li059.State = 1
    End If
    ' check modes
...
Sub Target009_Hit
    ...
    DMD "_", CL("    LOCK IS LIT"), "", eNone, eNone, eNone, 1500, True, "vo_lockislit" &RndNbr(6) : pupevent 850
    li060.State = 1
    li064.State = 1
    Tlock.Enabled = 1
    Clock.Enabled = 1
...
Sub StartMode
    ...
    Select Case Mode(CurrentPlayer, 0)
        Case 1               'Eddie
            DMD CL("    DEFEAT IOSEF"), CL("  FIRE THE SPINNER"), "", eNone, eNone, eNone, 3500, True, "vo_saveeddie" : PuPEvent 800
            DMD CL("    DEFEAT IOSEF"), CL("  FIRE THE SPINNER"), "", eNone, eNone, eNone, 1500, True, "vo_shootspinner" : pupevent 800
            Arrows(9) = 2
            SpinCount1 = 0
        Case 2 'Ben
            DMD CL("   DEFEAT VIGGO"), CL("   HIT POP BUMPERS"), "", eNone, eNone, eNone, 3500, True, "vo_taunt34" : PuPEvent 801
            DMD CL("   DEFEAT VIGGO"), CL("   HIT POP BUMPERS"), "", eNone, eNone, eNone, 1500, True, "vo_shootbumpers" &RndNbr(2) : pupevent 801
            RiseRamp
            li058.State = 2
            Lbumper1.State = 2
            Lbumper2.State = 2
            ...
            BumperHits2 = 0
        Case 3 'Richie
            DMD CL("   DEFEAT CASSIAN"), CL("  FIRE THE RAMPS"), "", eNone, eNone, eNone, 2500, True, "vo_taunt23" : PuPEvent 802
            DMD CL("   DEFEAT CASSIAN"), CL("  FIRE THE RAMPS"), "", eNone, eNone, eNone, 1500, True, "vo_shootramps" : pupevent 802
            LowerRamp
            Arrows(2) = 2
            Arrows(3) = 2
            Arrows(6) = 2
            ...
            RampHits3 = 0
        Case 4 'Beverly
            DMD CL("    DEFEAT ARES"), CL("   FIRE THE ORBIT"), "", eNone, eNone, eNone, 2500, True, "vo_taunt20" : PuPEvent 803
            DMD CL("    DEFEAT ARES"), CL("   FIRE THE ORBIT"), "", eNone, eNone, eNone, 1500, True, "vo_shootorbits" : pupevent 803
            RiseRamp
            Arrows(2) = 2
            Arrows(9) = 2
            OrbitHits4 = 0
        Case 5 'Stanley
            Select Case RndNbr(2)
                Case 1:DMD CL("   DEFEAT SANTINO"), CL("   FIRE THE LIGHTS"), "", eNone, eNone, eNone, 2500, True, "vo_savestanley" : PuPEvent 804
                Case 2:DMD CL("   DEFEAT SANTINO"), CL("   FIRE THE LIGHTS"), "", eNone, eNone, eNone, 8000, True, "vo_savestanley2" : pupevent 804
            End Select
            DMD CL("   DEFEAT SANTINO"), CL("   FIRE THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, "vo_shootlights" : pupevent 804
            LowerRamp
            Arrows(2) = 2
            Arrows(5) = 2
            Arrows(7) = 2
        ...
        Case 6 'Mike - shoot lights one at a time
            DMD CL("    DEFEAT ZERO"), CL("   FIRE THE LIGHTS"), "", eNone, eNone, eNone, 2000, True, "vo_savemike" : PuPEvent 805
            DMD CL("    DEFEAT ZERO"), CL("   FIRE THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, "vo_shootlights" : pupevent 805
            Arrows(RndNbr(10)) = 2
            LightHits6 = 0
        Case 7 'Bill
            DMD CL("    DEFEAT HARKAN"), CL("    FIRE THE MARKS"), "", eNone, eNone, eNone, 2000, True, "vo_savebill" : PuPEvent 806
            DMD CL("    DEFEAT HARKAN"), CL("    FIRE THE MARKS"), "", eNone, eNone, eNone, 1500, True, "vo_shootlights" : pupevent 806
            Arrows(1) = 2
            Arrows(7) = 2
            Arrows(10) = 2
            TargetHits7 = 0
        ' Evasion modes
        Case 8 'Patrick
            DMD CL("    KOJI HELPS"), CL("    FIRE RED MARKS"), "", eNone, eNone, eNone, 2500, True, "vo_runpatrick" : PuPEvent 807
            DMD CL("    KOJI HELPS"), CL("    FIRE RED MARKS"), "", eNone, eBlink, eNone, 1500, True, "vo_shootyellowtargets" : pupevent 807
            Arrows(1) = 2
            EndModeCountdown = 90
            EndModeTimer.Enabled = 1
        Case 9 'Bowers
            DMD CL("    CAINE HELPS"), CL("   FIRE GREEN MARKS"), "", eNone, eNone, eNone, 3500, True, "vo_runhenry" &RndNbr(2) : PuPEvent 808
            DMD CL("    CAINE HELPS"), CL("   FIRE GREEN MARKS"), "", eNone, eBlink, eNone, 1500, True, "vo_shootgreentargets" : pupevent 808
            Arrows(7) = 2
            EndModeCountdown = 90
            EndModeTimer.Enabled = 1
        Case 10 'Belch 
            DMD CL("   MR NOBODY HELPS"), CL("   FIRE BLUE MARKS"), "", eNone, eNone, eNone, 7500, True, "vo_runbelchor" &RndNbr(2) : PuPEvent 809
            DMD CL("   MR NOBODY HELPS"), CL("   FIRE BLUE MARKS"), "", eNone, eBlink, eNone, 1500, True, "vo_shootbluetargets" :pupevent 809
            Arrows(10) = 2
            EndModeCountdown = 90
            EndModeTimer.Enabled = 1
        Case 11 'Victor
            DMD CL("   SOFIA HELPS"), CL("   HIT A COMBO"), "", eNone, eNone, eNone, 3000, True, "vo_runvictor" : PuPEvent 810
            DMD CL("   SOFIA HELPS"), CL("   HIT A COMBO"), "", eNone, eNone, eNone, 1500, True, "vo_shootramps" : pupevent 810
            LowerRamp
            Arrows(2) = 2
            Arrows(6) = 2
            Arrows(8) = 2
        ...
        'wizard modes
        Case 12 'wizard 1
            DMD CL("   HITMAN MODE"), CL("   FIRE JACKPOTS"), "", eNone, eNone, eNone, 2000, True, "vo_wizards1" : PuPEvent 811
            AddMultiball 2
            ChangeGI red
            ChangeGIIntensity 2
        ...
        Case 13              'wizard 2
            DMD CL("   ASSASSIN MODE"), CL("   FIRE JACKPOTS"), "", eNone, eNone, eNone, 2000, True, "vo_wizards2" : PuPEvent 812
            AddMultiball 3
            ChangeGi red
            ChangeGIIntensity 2
            RndJackpot_Timer 'turn on a Jackpot
            ...
            aBallWhiteGlowing = True
        Case 14              'Wizard 3
            DMD CL("  BOGGEYMAN MODE"), CL("   SHOOT JOHN WICK"), "", eNone, eNone, eNone, 2000, True, "vo_wizards3" : PuPEvent 813
            AddMultiball 4
            ChangeGi red
            ChangeGIIntensity 2
            JackpotLight(5) = 2
    ...
    Select Case Mode(CurrentPlayer, 0)
        Case 1
            If SpinCount1 = SpinsToCount1 Then
                DMD CL("  IOSEF DEFEATED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_eddiesaved" : PuPEvent 814
                WinMode
                SPJackpotLight(5) = 2
        ...
        Case 2
            If BumperHits2 = BumpersToHit2 Then
                DMD CL("  VIGGO DEFEATED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_bensaved" : PuPEvent 815
                WinMode
                SPJackpotLight(5) = 2
                SuperJackpotTimer.Enabled = 1
            End if
        Case 3
            If RampHits3 = RampsToHit3 Then
                DMD CL("  CASSIAN DEFEATED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_richiesaved" : PuPEvent 816
                WinMode
                SPJackpotLight(5) = 2
                SuperJackpotTimer.Enabled = 1
            End if
        Case 4
            If OrbitHits4 = OrbitsToHit4 Then
                DMD CL("  ARES DEFEATED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_beverlysaved" : PuPEvent 817
                WinMode
                SPJackpotLight(5) = 2
                SuperJackpotTimer.Enabled = 1
            End if
        Case 5
            If LightHits5 = LightsToHit5 Then
                DMD CL("  SANTINO DEFEATED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_stanleysaved" : PuPEvent 818
                WinMode
                SPJackpotLight(5) = 2
                SuperJackpotTimer.Enabled = 1
            End if
        Case 6
            If LightHits6 = LightsToHit6 Then
                DMD CL("  ZERO DEFEATED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_mikesaved" : PuPEvent 819
                WinMode
                SPJackpotLight(5) = 2
                SuperJackpotTimer.Enabled = 1
            Else
        ...
        Case 7
            If TargetHits7 = TargetsToHit7 Then
                DMD CL("   HARKAN DEFEATED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_billsaved" : PuPEvent 820
                WinMode
                SPJackpotLight(5) = 2
                SuperJackpotTimer.Enabled = 1
            End if
        Case 8
            DMD CL("  KOJI LOSES"), "", "_", eNone, eNone, eNone, 1500, True, "vo_patrickrun" : PuPEvent 821
            WinMode
            ExtraBallIsLit
        Case 9
            DMD CL("  CAINE LOSES"), "", "_", eNone, eNone, eNone, 1500, True, "vo_henryrun" : PuPEvent 822
            WinMode 
            ExtraBallIsLit
        Case 10
            DMD CL(" MR NOBODY LOSES"), "", "_", eNone, eNone, eNone, 1500, True, "vo_belchrun" : PuPEvent 823
            WinMode
            ExtraBallIsLit
        Case 11
            DMD CL("   SOFIA LOSES"), "", "_", eNone, eNone, eNone, 1500, True, "vo_victorrun" : PuPEvent 824
            WinMode
            ExtraBallIsLit
...
Sub StopMode 'called at the end of a ball and also from the stopmode timer during times modes
    ...
    Select Case Mode(CurrentPlayer, 0)
        ...
        Case 1:DMD CL("    IOSEF ESCAPED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_drain" &RndNbr(20) : PuPEvent 825
        Case 2:DMD CL("    VIGGO ESCAPED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_bendead" : PuPEvent 826
        Case 3:DMD CL("    CASSIAN ESCAPED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_richiedead" : PuPEvent 827
        Case 4:DMD CL("   ARES ESCAPED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_beverlydead" : PuPEvent 828
        Case 5:DMD CL("    SANTINO ESCAPED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_stanleydead" : PuPEvent 829
        Case 6:DMD CL("    ZERO ESCAPED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_mikedead" : PuPEvent 830
        Case 7:DMD CL("   HARKAN ESCAPED"), "", "_", eNone, eNone, eNone, 1500, True, "vo_billdead" : PuPEvent 831
        Case 8:DMD CL("     KOJI LOSES"), "", "_", eNone, eNone, eNone, 1500, True, "vo_patrickwon" : PuPEvent 832
        Case 9:DMD CL("    CAINE LOSES"), "", "_", eNone, eNone, eNone, 1500, True, "vo_henrywon" : PuPEvent 833
        Case 10:DMD CL("   MR NOBODY LOSES"), "", "_", eNone, eNone, eNone, 1500, True, "vo_benchorwon" : PuPEvent 834
        Case 11:DMD CL("    SOFIA LOSES"), "", "_", eNone, eNone, eNone, 1500, True, "vo_victorwon" : PuPEvent 835
        Case 12:DMD CL("    YOU FOUND"), CL("   THE TABLE"), "_", eBlink, eBlink, eNone, 3000, True, "vo_wizards4" : PuPEvent 836
        Case 13:DMD CL("   YOU FOUGHT"), CL("   THE TABLE"), "_", eBlink, eBlink, eNone, 3000, True, "vo_wizards5" : PuPEvent 837
        Case 14:DMD CL("   THE TABLE"), CL("   SURVIVED"), "_", eBlink, eBlink, eNone, 2000, True, "vo_wizards6" : PuPEvent 838
                 DMD CL("  BUT THEY WERE"), CL("  VICTORIOUS"), "_", eBlink, eBlink, eNone, 2000, True, "" : PuPEvent 839
    End Select
    For i = 1 to 14
        If Mode(CurrentPlayer, i) = 2 Then Mode(CurrentPlayer, i) = 0
    Next
...
Sub EndModeTimer_Timer '1 second timer to count down to end the timed modes
    ...
    If EndModeCountdown < 61 Then
        Select Case EndModeCountdown
            Case 16:DMD "_", CL("   TIME RUNNING OUT "), "_", eNone, eBlinkFast, eNone, 1000, True, "": PuPEvent 940
            ...
            Case 5:DMD "_", CL("     5"), "_", eNone, eBlinkFast, eNone, 1000, True, "vo_5" : PuPEvent 954
...
Sub Clock_Hit 'Center Lock
    ...
    If NOT bMultiBallMode Then 'in multiball the kicker should be already disabled
        ...
        Select Case BallsInLock(CurrentPlayer)
            Case 1
                DMD "_", CL("    BALL 1 LOCKED"), "_", eNone, eBlink, eNone, 1500, True, "vo_ball1locked": PuPEvent 951
                vpmtimer.addtimer 1500, "ClockExit '"
            Case 2
                DMD "_", CL("    BALL 2 LOCKED"), "_", eNone, eBlink, eNone, 1500, True, "vo_ball2locked": PuPEvent 952
                vpmtimer.addtimer 1500, "ClockExit '"
            Case 3
                DMD "_", CL("    BALL 3 LOCKED"), "_", eNone, eBlink, eNone, 1500, True, "vo_ball3locked": PuPEvent 953
...
Sub StartMultiball
    ...
    Select Case MultiballType(CurrentPlayer)
        Case 0 'normal 3 ball multiball, no jackpots, use it for completing modes
            DMD "_", CL("    GIVE ME A GUN"), "_", eNone, eBlink, eNone, 1500, True, "vo_multiball" : PuPEvent 842
            AddMultiball 2
        Case 1 'Georgie - 7 ball - random jackpots
            DMD CL("   EXCOMMUNICADO"), CL("    MULTIBALL"), "_", eBlink, eBlink, eNone, 1500, True, "": PuPEvent 843
            RndJackpot_Timer
        ...
        Case 2              'Fear - 4 ball - jackpots on left ramp, nice for combos, dark mode
            DMD CL("  PARABELLUM"), CL("    MULTIBALL"), "_", eBlink, eBlink, eNone, 1500, True, "" : PuPEvent 844
            LowerRamp
            JackPotLight(2) = 2
            NightMode
            AddMultiball 3
        ...
        Case 3              'Float - 5 ball - jackpots on right ramp, nice for combos, green fog
            DMD CL("ADJUDICATOR"), CL("   MULTIBALL"), "_", eBlink, eBlink, eNone, 1500, True, "" : PuPEvent 845
            JackPotLight(8) = 2
            Start_Fog
            AddMultiball 4
            DOF 159, DOFoff 'Turn Off Green Undercab
        ...
        Case 4              'Horrors - 7 ball - jackpots on orbits, all scores x balls in play
            DMD CL("    BABA YAGA"), CL("    MULTIBALL"), "_", eBlink, eBlink, eNone, 1500, True, "" : PuPEvent 846
            JackPotLight(2) = 2
            JackPotLight(9) = 2
            ChangeGi red
            ChangeGIIntensity 2
...
cPuPPack = "johnwick"    ' name of the PuP-Pack / PuPVideos folder for this table
...
Function GetRandomSong()
    ...
    trkpik = RndNbr(33)
    select case trkpik
        case 1 : GetRandomSong = "Assassins.mp3" 
        case 2 : GetRandomSong = "Blood Code.mp3"
        case 3 : GetRandomSong = "Catacombs.mp3"
        case 4 : GetRandomSong = "Cycle Samurais.mp3"
        case 5 : GetRandomSong = "Dock Shootout.mp3"
        case 6 : GetRandomSong = "Dreams.mp3"
        case 7 : GetRandomSong = "Drowning.mp3"
        case 8 : GetRandomSong = "Ex Ex Chapter 3.mp3"
        case 9 : GetRandomSong = "Ex Ex.mp3"
        case 10 : GetRandomSong = "Excomunicado.mp3"
        case 11 : GetRandomSong = "Glass House Fight.mp3"
        case 12 : GetRandomSong = "Grave Accusation.mp3"
        case 13 : GetRandomSong = "Hate Or Glory.mp3"
        case 14 : GetRandomSong = "High Table in Osaka.mp3"
        case 15 : GetRandomSong = "Horse Whisperer.mp3"
        case 16 : GetRandomSong = "John Wick Mode.mp3"
        case 17 : GetRandomSong = "LED Spirals (Extended).mp3"
        case 18 : GetRandomSong = "Long Way Down.mp3"
        case 19 : GetRandomSong = "On The Hunt.mp3"
        case 20 : GetRandomSong = "Osaka Phonk.mp3"
        case 21 : GetRandomSong = "Presto Museum Battle.mp3"
        case 22 : GetRandomSong = "Rain Chase.mp3"
        case 23 : GetRandomSong = "Really Pissed Off.mp3"
        case 24 : GetRandomSong = "Red Circle.mp3"
        case 25 : GetRandomSong = "Shark Chevelle.mp3"
        case 26 : GetRandomSong = "Shotgun Hot Tub.mp3"
        case 27 : GetRandomSong = "Shots Fired.mp3"
        case 28 : GetRandomSong = "Story Of Wick.mp3"
        case 29 : GetRandomSong = "Suits Maps And Guns.mp3"
        case 30 : GetRandomSong = "Urban Cowgirl.mp3"
        case 31 : GetRandomSong = "Warehouse Smack Down.mp3"
        case 32 : GetRandomSong = "Wetwork.mp3"
        case 33 : GetRandomSong = "Winter At The Continental.mp3"
    end Select
End Function
...
Sub PlayPupSong(name)
    If Song <> name Then
        Song =  name
        PlayMusic "./pupvideos/" & cPuPPack & "/Music/" & name, SongVolume
    End If
End Sub

Sub PlayPupSound(name)
    PlayMusic "./pupvideos/" & cPuPPack & "/SoundBoard/" & name, SongVolume
End Sub
...
Sub pupevent(EventNum)
    ...
    Select Case EventNum
        Case 811
            ' Trigger: 340,1,"SILENCE MUSIC",E811,4,Music,,0,1,,,,normal,0
            StopPupSong
        Case 812
            ' Trigger: 435,1,"SILENCE MUSIC",E812,4,Music,,0,1,,,,normal,0
            StopPupSong
        Case 813
            ' Trigger: 495,1,"SILENCE MUSIC",E813,4,Music,,0,1,,,,normal,0
            StopPupSong
        Case 842
            ' Trigger: 518,1,"GIVE ME A GUN MB",E842,4,SoundBoard,givemeagun.mp3,,1,,,,normal,0
            ' Trigger: 574,1,"Silence Music",E842,4,Music,,0,1,,,,normal,0
            StopPupSong
            PlayPupSound "givemeagun.mp3"
        Case 843
            ' Trigger: 44,1,"Silence Music",E843,4,Music,,0,1,,,,normal,0
            StopPupSong
        Case 844
            ' Trigger: 59,1,"Silence Music",E844,4,Music,,0,1,,,,normal,0
            StopPupSong
        Case 845
            ' Trigger: 69,1,"Silence Music",E845,4,Music,,0,1,,,,normal,0
            StopPupSong
        Case 846
            ' Trigger: 76,1,"Silence Music",E846,4,Music,,0,1,,,,normal,0
            StopPupSong
        Case 903
            ' Trigger: 2,1,"Music Start",E903,4,Music,,,1,,,,SetBG,0
            vpmtimer.addtimer 5700, "StartDelayedPupSong '"
        Case 904
            ' Trigger: 3,1,"Stop Music",E904,4,Music,,0,1,6,,,stop,0
            StopPupSong
        Case 909
            ' Trigger: 20,1,"Gameover music stop",E909,4,Music,,0,1,,,,SetBG,0
            StopPupSong
        Case 910
            ' Trigger: 13,1,"Stop Music",E910,4,Music,,0,1,6,,,SplashResume,0
            MutePupSong
            vpmtimer.addtimer 6000, "UnMutePupSong '"
        Case 950
            ' Trigger: 22,1,SoundBoard,E950,4,SoundBoard,,,1,,,,SplashResume,0
            PlayPupSound "somebodyplllzzzzzzz.mp3"
        Case 934
            ' Trigger: 52,1,"Start  Music",E934,4,Music,,,1,,,,SplashResume,0
            ' Trigger: 64,1,"Start Music",E934,4,Music,,,1,,,,SplashResume,0
            ' Trigger: 72,1,"Start Music",E934,4,Music,,,1,,,,SplashResume,0
            ' Trigger: 77,1,"Start Music",E934,4,Music,,,1,,,,SplashResume,0
            ' Trigger: 360,1,"START MUSIC",E934,4,Music,,,1,,,,SplashResume,0
            ' Trigger: 455,1,"START MUSIC",E934,4,Music,,,1,,,,SplashResume,0
            ' Trigger: 514,1,"START MUSIC",E934,4,Music,,,1,,,,SplashResume,0
            ' Trigger: 628,1,"Start Music",E934,4,Music,,,1,,,,SplashResume,0
            PlayPupSong GetRandomSong
    End Select
...
Dim	Gun1Pos, Frames
Frames = Array("MF-000", "MF-001", "MF-002", "MF-003", "MF-004", "MF-005", "MF-006", "MF-007", "MF-008", "MF-009", "MF-010", "MF-011", "MF-012", "MF-013", "MF-014", "MF-015", "MF-016", "MF-017", "MF-018", "MF-019", "MF-020", "MF-021", "MF-022", "MF-023", "MF-024", "MF-025", "MF-026", "MF-027", "MF-028", "MF-029")
...
'Sub PFVideo_Timer()
'		PFVideo.VideoCapUpdate="PUPSCREEN17"
'end Sub		


'If TiltVideo = 1 Then
'Sub Tiltvideo
'	PFVideo.VideoCapWidth=1080
'	PFVideo.VideoCapHeight=1920
'	PFVideo.visible=true	
'    PFVideo.TimerEnabled=true
 '   PFVideo.TimerInterval=40
'	vpmtimer.addtimer 18000, "StopPFVideo '"
'End Sub

'Sub StopPFVideo
'	PFVideo.visible= False
'End Sub	

'************************************Farois****************************************

Dim Farois1Pos, Frame1
Frame1 = Array ("Farois", "FaroisTransparent")

Sub FaroisPisca
	FaroisFlash.visible = 1
	Farois1Pos = 0
	FaroisTimer.Enabled = 1
End Sub

Sub FaroisTimer_Timer
	FaroisFlash.ImageA = Frame1(Farois1Pos)
	Farois1Pos = (Farois1Pos + 1 ) MOD 2
	vpmtimer.addtimer 3500, "StopFarois '"
End Sub

Sub StopFarois
	FaroisTimer.Enabled = 0
	'FaroisFlash.ImageA = Farois
End Sub
...
Sub CabGlassStart
	CabGlass.visible = 1
	PlaySound "1shotglass"
	CabGlass.ImageA = "1Shot"
	vpmtimer.addtimer 500, "CabGlassStart1 '"
End Sub
	
Sub CabGlassStart1
	PlaySound "1shot"
	CabGlass.ImageA = "2Shot"
	vpmtimer.addtimer 500, "CabGlassStart2 '"
End Sub


Sub CabGlassStart2
	PlaySound "1shot"
	CabGlass.ImageA = "3Shot"
...
Sub CabGlassStart3
	PlaySound "2shots"
	CabGlass.ImageA = "4Shot"
	CabGlass.ImageA = "5Shot"
...
Sub CabGlassStart4
	PlaySound "6shots"
	CabGlass.ImageA = "6Shot"
	vpmtimer.addtimer 500, "CabGlassStart5 '"
End Sub


Sub CabGlassStart5
	CabGlass.ImageA = "7Shot"
	vpmtimer.addtimer 400, "CabGlassStart6 '"
End Sub


Sub CabGlassStart6
	CabGlass.ImageA = "8Shot"
	vpmtimer.addtimer 400, "CabGlassStart7 '"
End Sub


Sub CabGlassStart7
	CabGlass.ImageA = "9Shot"
	vpmtimer.addtimer 400, "CabGlassStart8 '"
End Sub

Sub CabGlassStart8
	CabGlass.ImageA = "10Shot"
	vpmtimer.addtimer 400, "CabGlassStart9 '"
End Sub

Sub CabGlassStart9
	CabGlass.ImageA = "11Shot"
	vpmtimer.addtimer 400, "CabGlassStart10 '"
End Sub

Sub CabGlassStart10
	CabGlass.ImageA = "12Shot"
	vpmtimer.addtimer 400, "CabGlassStart11 '"
End Sub

Sub CabGlassStart11
	CabGlass.ImageA = "13Shot"
	'vpmtimer.addtimer 10, "CabGlassStart12 '"
End Sub
